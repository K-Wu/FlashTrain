# Adapted from https://github.com/K-Wu/Megatron-DeepSpeed/blob/b72381ec437856b20c6150b44da2c26b9b8e7739/pretrain_t5.py (forked from github.com/microsoft/Megatron-DeepSpeed/) and added tensor cache logic
