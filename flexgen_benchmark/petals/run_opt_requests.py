...
def main():
    ...
    parser.add_argument(
        ...
        nargs="*",
        help=(
            "Multiaddrs of the peers that will welcome you into the existing"
            " DHT. Example: /ip4/203.0.113.1/tcp/31337/p2p/XXXX"
            " /ip4/203.0.113.2/tcp/7777/p2p/YYYY"
        ),
    )
    parser.add_argument(
        "--prefix", default="facebook/opt-175b", help="Prefix of the model."
    )
    ...
    config_bloom = DistributedBloomConfig.from_pretrained(
