...
class Message:
    ...
    def category_failures(self) -> Dict:
        ...
        category_failures = {
            k: v["failed"]
            for k, v in doc_test_results.items()
        ...
        return {
            ...
            "text": {
                "type": "mrkdwn",
                "text": (
                    f"The following examples had failures:\n\n\n{report}\n"
                ),
            },
        }
    ...
    def get_reply_blocks(self, job_name, job_link, failures, text):
        ...
        return [
            ...
            {
                "type": "section",
                "text": {"type": "mrkdwn", "text": failures_text},
            },
        ]
        ...
        for job, job_result in sorted_dict:
            if len(job_result["failures"]):
                ...
                blocks = self.get_reply_blocks(
                    job, job_link, failures, text=text
                )
