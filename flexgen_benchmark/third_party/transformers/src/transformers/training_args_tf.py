...
class TFTrainingArguments(TrainingArguments):
    ...
    def _setup_strategy(self) -> Tuple["tf.distribute.Strategy", int]:
        ...
        if self.no_cuda:
            ...
            try:
                ...
                if self.tpu_name:
                    raise RuntimeError(
                        f"Couldn't connect to TPU {self.tpu_name}!"
                    )
                else:
                    tpu = None
            ...
            if tpu:
                ...
                raise ValueError(
                    "Cannot find the proper strategy, please check your"
    ...
    def n_gpu(self) -> int:
        ...
        warnings.warn(
            (
                "The n_gpu argument is deprecated and will be removed in a"
                " future version, use n_replicas instead."
            ),
            FutureWarning,
        )
        return self._setup_strategy.num_replicas_in_sync
