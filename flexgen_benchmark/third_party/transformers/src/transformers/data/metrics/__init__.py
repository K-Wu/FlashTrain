...
DEPRECATION_WARNING = (
    "This metric will be removed from the library soon, metrics should be"
    " handled with the 🤗 Evaluate "
...
def glue_compute_metrics(task_name, preds, labels):
    ...
    assert len(preds) == len(labels), (
        f"Predictions and labels have mismatched lengths {len(preds)} and"
        f" {len(labels)}"
    )
    if task_name == "cola":
