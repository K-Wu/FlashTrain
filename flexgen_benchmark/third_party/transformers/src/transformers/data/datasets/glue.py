...
class GlueDataset(Dataset):
    ...
    def __init__(
        ...
        warnings.warn(
            (
                "This dataset will be removed from the library soon,"
                " preprocessing should be handled with the 🤗 Datasets "
                "library. You can have a look at this example script for"
                " pointers: "
