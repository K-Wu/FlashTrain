...
def check_min_version(min_version):
    if version.parse(__version__) < version.parse(min_version):
        if "dev" in min_version:
            error_message = (
                "This example requires a source install from HuggingFace"
                " Transformers (see "
        ...
        raise ImportError(
            error_message
            + "Check out https://huggingface.co/transformers/examples.html for"
            " the examples corresponding to other versions of HuggingFace"
            " Transformers."
        )
