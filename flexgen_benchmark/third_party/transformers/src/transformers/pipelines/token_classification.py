    ...
    def __call__(self, inputs: Union[str, List[str]], **kwargs):
        ...
        if offset_mapping:
            ...
            if len(offset_mapping) != batch_size:
                raise ValueError(
                    "offset_mapping should have the same batch size as the"
                    " input"
                )
...
class TokenClassificationPipeline(Pipeline):
    ...
    def _sanitize_parameters(
        ...
        if grouped_entities is not None or ignore_subwords is not None:
            ...
            if grouped_entities is not None:
                warnings.warn(
                    "`grouped_entities` is deprecated and will be removed in"
                    " version v5.0.0, defaulted to"
                    f' `aggregation_strategy="{aggregation_strategy}"`'
                    " instead."
                )
            if ignore_subwords is not None:
                warnings.warn(
                    "`ignore_subwords` is deprecated and will be removed in"
                    " version v5.0.0, defaulted to"
                    f' `aggregation_strategy="{aggregation_strategy}"`'
                    " instead."
                )
        ...
        if aggregation_strategy is not None:
            ...
            if (
                ...
                raise ValueError(
                    ...
                    ' `aggregation_strategy` optionto `"simple"` or use a fast'
                    " tokenizer."
                )
            ...
            if offset_mapping is not None:
                ...
                if getattr(
                    ...
                    if aggregation_strategy in {
                        ...
                        warnings.warn(
                            (
                                "Tokenizer does not support real words, using"
                                " fallback heuristic"
                            ),
                            UserWarning,
                        )
    ...
    def aggregate_word(
        ...
        if aggregation_strategy == AggregationStrategy.FIRST:
            ...
            max_entity = max(
                entities, key=lambda entity: entity["scores"].max()
            )
