...
class LayoutLMv3Model(LayoutLMv3PreTrainedModel):
    ...
    def init_visual_bbox(self, image_size=(14, 14), max_len=1000):
        ...
        cls_token_box = torch.tensor(
            [[0 + 1, 0 + 1, max_len - 1, max_len - 1]]
        )
    ...
    @add_start_docstrings_to_model_forward(
        LAYOUTLMV3_MODEL_INPUTS_DOCSTRING.format(
    ...
    def __init__(self, config):
        ...
        if config.num_labels < 10:
            ...
            self.classifier = LayoutLMv3ClassificationHead(
                config, pool_feature=False
            )

        self.init_weights()

    @add_start_docstrings_to_model_forward(
        LAYOUTLMV3_DOWNSTREAM_INPUTS_DOCSTRING.format(
...
class LayoutLMv3ForQuestionAnswering(LayoutLMv3PreTrainedModel):
    ...
    def __init__(self, config):
        ...
        self.layoutlmv3 = LayoutLMv3Model(config)
        self.qa_outputs = LayoutLMv3ClassificationHead(
            config, pool_feature=False
        )
