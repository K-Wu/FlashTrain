...
BLOOM_PRETRAINED_CONFIG_ARCHIVE_MAP = {
    "bigscience/bloom": (
        "https://huggingface.co/bigscience/bloom/resolve/main/config.json"
    ),
    "bigscience/bloom-560m": (
        "https://huggingface.co/bigscience/bloom-560m/blob/main/config.json"
    ),
    "bigscience/bloom-1b1": (
        "https://huggingface.co/bigscience/bloom-1b1/blob/main/config.json"
    ),
    "bigscience/bloom-1b7": (
        "https://huggingface.co/bigscience/bloom-1b7/blob/main/config.json"
    ),
    "bigscience/bloom-3b": (
        "https://huggingface.co/bigscience/bloom-3b/blob/main/config.json"
    ),
        ...
        if self.use_past:
            if not is_torch_available():
                ...
                ordered_inputs["past_key_values"] = [
                    (
                        torch.zeros(past_key_shape),
                        torch.zeros(past_value_shape),
                    )
