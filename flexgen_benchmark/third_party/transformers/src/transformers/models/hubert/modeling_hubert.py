...
@add_start_docstrings(
    (
        "The bare Hubert Model transformer outputting raw hidden-states"
    ...
    def __init__(self, config):
        ...
        if config.vocab_size is None:
            raise ValueError(
                ...
                " follows: `HubertForCTC.from_pretrained(...,"
...
class HubertForSequenceClassification(HubertPreTrainedModel):
    def __init__(self, config):
        ...
        if hasattr(config, "add_adapter") and config.add_adapter:
            raise ValueError(
                "Sequence classification does not support the use of Hubert"
