...
class GLPNImageProcessor(BaseImageProcessor):
    ...
    def rescale(
        ...
        **kwargs
        ...
        """
        return rescale(
            image=image, scale=scale, data_format=data_format, **kwargs
        )
    ...
    def preprocess(
        ...
        **kwargs
        ...
        size_divisor = (
            size_divisor if size_divisor is not None else self.size_divisor
        )
        ...
        if do_resize:
            images = [
                self.resize(
                    image, size_divisor=size_divisor, resample=resample
                )
                for image in images
            ]
