...
_CTC_EXPECTED_OUTPUT = (
    "'MISTER QUILTER IS THE APOSTIL OF THE MIDDLE CLASSES AND WE ARE GLAD TO"
    " WELCOME HIS GOSPEL'"
)
...
@add_start_docstrings(
    (
        "The bare SEW-D Model transformer outputting raw hidden-states without"
    ...
    def __init__(self, config):
        ...
        if config.vocab_size is None:
            raise ValueError(
                ...
                " follows: `SEWDForCTC.from_pretrained(...,"
...
class SEWDForSequenceClassification(SEWDPreTrainedModel):
    def __init__(self, config):
        ...
        if hasattr(config, "add_adapter") and config.add_adapter:
            raise ValueError(
                "Sequence classification does not support the use of SEWD"
