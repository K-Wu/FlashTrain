...
@add_start_docstrings(
    (
        "The bare Wav2Vec2 Model transformer outputting raw hidden-states"
...
class Wav2Vec2ForMaskedLM(Wav2Vec2PreTrainedModel):
    def __init__(self, config):
        ...
        warnings.warn(
            (
                "The class `Wav2Vec2ForMaskedLM` is deprecated. Please use"
                " `Wav2Vec2ForCTC` instead."
            ),
            FutureWarning,
        )
    ...
    def __init__(self, config):
        ...
        if config.vocab_size is None:
            raise ValueError(
                ...
                " follows: `Wav2Vec2ForCTC.from_pretrained(...,"
...
class Wav2Vec2ForSequenceClassification(Wav2Vec2PreTrainedModel):
    def __init__(self, config):
        ...
        if hasattr(config, "add_adapter") and config.add_adapter:
            raise ValueError(
                "Sequence classification does not support the use of Wav2Vec2"
    ...
    def __init__(self, config):
        ...
        if hasattr(config, "add_adapter") and config.add_adapter:
            raise ValueError(
                ...
                " Wav2Vec2 adapters (config.add_adapter=True)"
            )
        self.wav2vec2 = Wav2Vec2Model(config)
        num_layers = (
            config.num_hidden_layers + 1
