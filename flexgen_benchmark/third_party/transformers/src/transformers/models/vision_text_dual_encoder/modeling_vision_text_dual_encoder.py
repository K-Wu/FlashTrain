...
class VisionTextDualEncoderModel(PreTrainedModel):
    ...
    def __init__(
        ...
        if config is None and (vision_model is None or text_model is None):
            raise ValueError(
                "Either a configuration or an vision and a text model has to"
                " be provided"
            )
    ...
    @replace_return_docstrings(
        output_type=CLIPOutput, config_class=_CONFIG_FOR_DOC
    )
    def forward(
        self,
        input_ids=None,
    ...
    def from_vision_text_pretrained(
        ...
        **kwargs,
        ...
        # init model
        model = cls(
            config=config, vision_model=vision_model, text_model=text_model
        )
        ...
        logger.warning(
            ...
            " 'logit_scale']` are newly initialized. You should probably TRAIN"
