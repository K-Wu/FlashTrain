...
class ProphetNetPreTrainedModel(PreTrainedModel):
    ...
    def _shift_right(self, input_ids):
        ...
        assert decoder_start_token_id is not None, (
            ...
            " ProphetNet it is usually set to the pad_token_id. See ProphetNet"
...
@add_start_docstrings(
    (
        "The standalone decoder part of the ProphetNetModel with a lm head on"
        " top. The model can be used for causal language modeling."
    ),
    PROPHETNET_START_DOCSTRING,
)
