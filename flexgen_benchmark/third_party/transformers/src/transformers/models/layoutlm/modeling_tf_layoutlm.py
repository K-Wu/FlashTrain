...
class TFLayoutLMLayer(tf.keras.layers.Layer):
    def __init__(self, config: LayoutLMConfig, **kwargs):
        ...
        if self.add_cross_attention:
            ...
            self.crossattention = TFLayoutLMAttention(
...
class TFLayoutLMLMPredictionHead(tf.keras.layers.Layer):
    def __init__(
        ...
        **kwargs,
        ...
        self.transform = TFLayoutLMPredictionHeadTransform(
...
class TFLayoutLMMainLayer(tf.keras.layers.Layer):
    ...
    def __init__(
        ...
        self.pooler = (
            TFLayoutLMPooler(config, name="pooler")
...
@add_start_docstrings(
    (
        "The bare LayoutLM Model transformer outputting raw hidden-states"
...
class TFLayoutLMForMaskedLM(
    TFLayoutLMPreTrainedModel, TFMaskedLanguageModelingLoss
):
    ...
    def __init__(self, config: LayoutLMConfig, *inputs, **kwargs):
        ...
        if config.is_decoder:
            logger.warning(
                "If you want to use `TFLayoutLMForMaskedLM` make sure"
