...
class TFMultiHeadAttention(tf.keras.layers.Layer):
    def __init__(
        self, d_model_size, num_heads, output_attentions=False, **kwargs
    ):
...
class TFCTRLMainLayer(tf.keras.layers.Layer):
    ...
    def call(
        ...
        inputs_embeds *= tf.math.sqrt(
            tf.cast(self.d_model_size, inputs_embeds.dtype)
        )
...
@add_start_docstrings(
    (
        "The bare CTRL Model transformer outputting raw hidden-states without"
