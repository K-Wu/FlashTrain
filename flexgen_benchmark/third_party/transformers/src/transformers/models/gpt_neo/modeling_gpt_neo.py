    ...
    def __init__(self, config, layer_id=0):
        ...
        if self.attention_type in ["global", "local"]:
            ...
            raise NotImplementedError(
                "Only attn layer types 'global' and 'local' exist, but got"
                f" `config.attention_layers`: {config.attention_layers}."
...
@add_start_docstrings(
    (
        "The bare GPT Neo Model transformer outputting raw hidden-states"
