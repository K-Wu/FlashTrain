...
class OwlViTConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            text_config=text_config, vision_config=vision_config, **kwargs
        )

        if text_config is None:
            text_config = {}
            logger.info(
                "text_config_dict is None. Initializing the OwlViTTextConfig"
                " with default values."
            )
        ...
        if vision_config is None:
            ...
            logger.info(
                ...
                " OwlViTVisionConfig with default values."
            )
