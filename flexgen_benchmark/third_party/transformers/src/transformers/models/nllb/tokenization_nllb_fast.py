...
PRETRAINED_VOCAB_FILES_MAP = {
    "vocab_file": {
        "facebook/nllb-200-distilled-600M": "https://huggingface.co/facebook/nllb-200-distilled-600M/resolve/main/sentencepiece.bpe.model",
    },
    "tokenizer_file": {
    ...
    def _build_translation_inputs(
        ...
        **extra_kwargs,
        ...
        if src_lang is None or tgt_lang is None:
            raise ValueError(
                "Translation requires a `src_lang` and a `tgt_lang` for this"
                " model"
            )
