...
def get_xclip_config(model_name, num_frames):
    ...
    vision_config = XCLIPVisionConfig(
        patch_size=patch_size, num_frames=num_frames
    )
...
def rename_key(name):
    ...
    if "visual.conv1" in name:
        name = name.replace(
            "visual.conv1", "vision_model.embeddings.patch_embedding"
        )
    ...
    if name.startswith("prompts_generator.norm"):
        name = name.replace(
            "prompts_generator.norm", "prompts_generator.layernorm"
        )
...
def convert_xclip_checkpoint(
    ...
    model_to_url = {
        ...
        "xclip-base-patch32-16-frames": "https://github.com/nbl97/X-CLIP_Model_Zoo/releases/download/v1.0/k400_32_16.pth",
        "xclip-base-patch16": "https://github.com/nbl97/X-CLIP_Model_Zoo/releases/download/v1.0/k400_16_8.pth",
        "xclip-base-patch16-16-frames": "https://github.com/nbl97/X-CLIP_Model_Zoo/releases/download/v1.0/k400_16_16.pth",
        "xclip-large-patch14": "https://drive.google.com/u/0/uc?id=1NUOImq0o5DlQTST17iIP3vG7DgmHQuCx&amp;export=download&amp;confirm=t&amp;uuid=b26caedc-88e2-473e-830a-9d158b653cdb",
        "xclip-large-patch14-16-frames": "https://drive.google.com/u/0/uc?id=1FOYgnJc097OJ4lGwtRCCydQyVPJEOH7d&amp;export=download&amp;confirm=t&amp;uuid=538fa810-e671-4050-b385-9a623f89804f",
        # fully supervised kinetics-600 checkpoints
        "xclip-base-patch16-kinetics-600": "https://github.com/nbl97/X-CLIP_Model_Zoo/releases/download/v1.0/k600_16_8.pth",
        "xclip-base-patch16-kinetics-600-16-frames": "https://github.com/nbl97/X-CLIP_Model_Zoo/releases/download/v1.0/k600_16_16.pth",
        "xclip-large-patch14-kinetics-600": "https://drive.google.com/u/0/uc?id=1FV8C1INuM91sLAN4ImjzePLIlpMSihwV&amp;export=download&amp;confirm=t&amp;uuid=141d4977-4a65-44ae-864f-4b0c19f838be",
        # few shot
        "xclip-base-patch16-hmdb-2-shot": "https://github.com/nbl97/X-CLIP_Model_Zoo/releases/download/v1.0/few_hmdb_2.pth",
        "xclip-base-patch16-hmdb-4-shot": "https://github.com/nbl97/X-CLIP_Model_Zoo/releases/download/v1.0/few_hmdb_4.pth",
        "xclip-base-patch16-hmdb-8-shot": "https://github.com/nbl97/X-CLIP_Model_Zoo/releases/download/v1.0/few_hmdb_8.pth",
        "xclip-base-patch16-hmdb-16-shot": "https://github.com/nbl97/X-CLIP_Model_Zoo/releases/download/v1.0/few_hmdb_16.pth",
        "xclip-base-patch16-ucf-2-shot": "https://github.com/nbl97/X-CLIP_Model_Zoo/releases/download/v1.0/few_ucf_2.pth",
        "xclip-base-patch16-ucf-4-shot": "https://github.com/nbl97/X-CLIP_Model_Zoo/releases/download/v1.0/few_ucf_4.pth",
        "xclip-base-patch16-ucf-8-shot": "https://github.com/nbl97/X-CLIP_Model_Zoo/releases/download/v1.0/few_ucf_8.pth",
        "xclip-base-patch16-ucf-16-shot": "https://github.com/nbl97/X-CLIP_Model_Zoo/releases/download/v1.0/few_ucf_16.pth",
        # zero shot
    ...
    slow_tokenizer = CLIPTokenizer.from_pretrained(
        "openai/clip-vit-base-patch32"
    )
    fast_tokenizer = CLIPTokenizerFast.from_pretrained(
        "openai/clip-vit-base-patch32"
    )
    ...
    if push_to_hub:
        print(
            "Pushing model, processor and slow tokenizer files to the hub..."
        )
