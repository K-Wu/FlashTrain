...
class T5PreTrainedModel(PreTrainedModel):
    ...
    def _shift_right(self, input_ids):
        ...
        assert decoder_start_token_id is not None, (
            "self.model.config.decoder_start_token_id has to be defined. In T5"
            " it is usually set to the pad_token_id. See T5 docs for more"
            " information"
        )
...
@add_start_docstrings(
    (
        "The bare T5 Model transformer outputting raw hidden-states without"
