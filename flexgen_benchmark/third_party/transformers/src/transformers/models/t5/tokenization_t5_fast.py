...
class T5TokenizerFast(PreTrainedTokenizerFast):
        ...
        **kwargs,
        ...
        if extra_ids > 0 and additional_special_tokens is None:
            ...
            extra_tokens = len(
                set(
                    filter(
                        lambda x: bool("extra_id_" in str(x)),
                        additional_special_tokens,
                    )
                )
            )
    ...
    def _eventually_correct_t5_max_length(
        ...
        if (
            ...
            in T5TokenizerFast.max_model_input_sizes
        ):
            deprecated_max_model_length = (
    ...
    def save_vocabulary(
        ...
        if not self.can_save_slow_tokenizer:
            raise ValueError(
                "Your fast tokenizer does not have the necessary information"
