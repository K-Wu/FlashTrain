...
DEPRECATION_WARNING = (
    "Version v4.12.0 introduces a better way to train encoder-decoder models"
    ...
    " fine-tuning a model trained with versions anterior to 4.12.0. The"
...
class EncoderDecoderModel(PreTrainedModel):
    ...
    def from_pretrained(
        ...
        if kwargs.get("_fast_init", False):
            logger.warning(
                "Fast initialization is currently not supported for"
                " EncoderDecoderModel. Falling back to slow initialization..."
            )
    ...
    def resize_token_embeddings(self, *args, **kwargs):
        raise NotImplementedError(
            "Resizing the embedding layers via the EncoderDecoderModel"
