...
class BertweetTokenizer(PreTrainedTokenizer):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        try:
            ...
            logger.warning(
                "emoji is not installed, thus not converting emoticons or"
                " emojis into text. Install emoji: pip3 install emoji==0.6.0"
            )
            self.demojizer = None
    ...
    def _tokenize(self, text):
        ...
        if (
            self.normalization
        ):  # Perform Tweet normalization before performing BPE
