...
class BlenderbotSmallPreTrainedModel(PreTrainedModel):
    ...
    def _set_gradient_checkpointing(self, module, value=False):
        if isinstance(
            module, (BlenderbotSmallDecoder, BlenderbotSmallEncoder)
        ):
...
class BlenderbotSmallEncoder(BlenderbotSmallPreTrainedModel):
    ...
    def __init__(
        ...
        self.layers = nn.ModuleList(
            [
                BlenderbotSmallEncoderLayer(config)
...
class BlenderbotSmallDecoder(BlenderbotSmallPreTrainedModel):
    ...
    def __init__(
        ...
        self.layers = nn.ModuleList(
            [
                BlenderbotSmallDecoderLayer(config)
...
@add_start_docstrings(
    (
        "The bare BlenderbotSmall Model outputting raw hidden-states without"
...
@add_start_docstrings(
    (
        "The BlenderbotSmall Model with a language modeling head. Can be used"
        " for summarization."
    ),
    BLENDERBOT_SMALL_START_DOCSTRING,
)
