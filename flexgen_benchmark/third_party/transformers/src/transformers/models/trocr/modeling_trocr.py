...
class TrOCRSinusoidalPositionalEmbedding(nn.Module):
    ...
    def __init__(
        ...
        self.weights = self.get_embedding(
            num_positions, embedding_dim, padding_idx
        )
...
@add_start_docstrings(
    (
        "The TrOCR Model with a language modeling head. Can be used for"
        " summarization."
    ),
...
@add_start_docstrings(
    (
        "The TrOCR Decoder with a language modeling head. Can be used as the"
        " decoder part of [`EncoderDecoderModel`] and"
