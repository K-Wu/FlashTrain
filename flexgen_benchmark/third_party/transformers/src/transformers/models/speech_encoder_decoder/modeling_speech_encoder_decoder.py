...
class SpeechEncoderDecoderModel(PreTrainedModel):
    ...
    def from_pretrained(cls, *args, **kwargs):
        ...
        if kwargs.get("_fast_init", False):
            logger.warning(
                ...
                " SpeechEncoderDecoderModel. Falling back to slow"
                " initialization..."
            )
        ...
        if encoder_outputs is None:
            if inputs is None:
                if input_values is not None and input_features is not None:
                    raise ValueError(
                        "You cannot specify both input_values and"
                        " input_features at the same time"
                    )
                    ...
                    raise ValueError(
                        "You have to specify either input_values or"
                        " input_features"
                    )
    ...
    def resize_token_embeddings(self, *args, **kwargs):
        raise NotImplementedError(
            "Resizing the embedding layers via the SpeechEncoderDecoderModel"
            " directly is not supported. Please use the respective methods of"
            " the wrapped decoder object"
