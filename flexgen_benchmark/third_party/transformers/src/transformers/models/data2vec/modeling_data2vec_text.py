...
@add_start_docstrings(
    (
        "The bare Data2VecText Model for text transformer outputting raw"
...
class Data2VecTextForCausalLM(Data2VecTextPreTrainedModel):
    ...
    def __init__(self, config):
        ...
        if not config.is_decoder:
            logger.warning(
                "If you want to use `Data2VecTextLMHeadModel` as a standalone,"
                " add `is_decoder=True.`"
            )
...
class Data2VecTextForMaskedLM(Data2VecTextPreTrainedModel):
    ...
    def __init__(self, config):
        ...
        if config.is_decoder:
            logger.warning(
                "If you want to use `Data2VecTextForMaskedLM` make sure"
...
class Data2VecTextForMultipleChoice(Data2VecTextPreTrainedModel):
    ...
    @add_start_docstrings_to_model_forward(
        DATA2VECTEXT_INPUTS_DOCSTRING.format(
