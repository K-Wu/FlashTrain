...
class Data2VecVisionAttention(nn.Module):
    def __init__(
        ...
        super().__init__()
        self.attention = Data2VecVisionSelfAttention(
            config, window_size=window_size
        )
...
class Data2VecVisionLayer(nn.Module):
    ...
    def __init__(
        ...
        self.seq_len_dim = 1
        self.attention = Data2VecVisionAttention(
            config, window_size=window_size
        )
...
class Data2VecVisionRelativePositionBias(nn.Module):
    def __init__(
        self, config: Data2VecVisionConfig, window_size: tuple
    ) -> None:
        super().__init__()
...
class Data2VecVisionModel(Data2VecVisionPreTrainedModel):
    def __init__(
        ...
        self.pooler = (
            Data2VecVisionPooler(config) if add_pooling_layer else None
        )
...
class Data2VecVisionForImageClassification(Data2VecVisionPreTrainedModel):
    def __init__(self, config: Data2VecVisionConfig) -> None:
        ...
        self.data2vec_vision = Data2VecVisionModel(
...
class Data2VecVisionPyramidPoolingBlock(nn.Module):
    def __init__(
        self, pool_scale: int, in_channels: int, channels: int
    ) -> None:
        super().__init__()
        self.layers = [
...
class Data2VecVisionUperHead(nn.Module):
    ...
    def __init__(self, config: Data2VecVisionConfig) -> None:
        ...
        for in_channels in self.in_channels[:-1]:  # skip the top layer
            l_conv = Data2VecVisionConvModule(
                in_channels, self.channels, kernel_size=1
            )
