...
def convert_xlnet_checkpoint_to_pytorch(
    ...
    finetuning_task = (
        finetuning_task.lower() if finetuning_task is not None else ""
    )
    if finetuning_task in GLUE_TASKS_NUM_LABELS:
        print(
            "Building PyTorch XLNetForSequenceClassification model from"
    ...
    print(
        ...
        f" {os.path.abspath(pytorch_config_dump_path)}"
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        required=True,
        help=(
            "The config json file corresponding to the pre-trained XLNet"
