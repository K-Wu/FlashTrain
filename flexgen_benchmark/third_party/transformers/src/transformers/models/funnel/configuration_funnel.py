...
class FunnelConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        assert pooling_type in [
            ...
            f"Got {pooling_type} for `pooling_type` but only 'mean' and 'max'"
            " are supported."
        )
        ...
        assert attention_type in [
            ...
            f"Got {attention_type} for `attention_type` but only"
            " 'relative_shift' and 'factorized' are supported."
        )
    ...
    def num_hidden_layers(self, value):
        raise NotImplementedError(
            "This model does not support the setting of `num_hidden_layers`."
            " Please set `block_sizes`."
        )
    ...
    def num_blocks(self, value):
        raise NotImplementedError(
            "This model does not support the setting of `num_blocks`. Please"
            " set `block_sizes`."
        )
