...
class Speech2Text2Decoder(Speech2Text2PreTrainedModel):
    ...
    def __init__(self, config: Speech2Text2Config):
        ...
        self.layers = nn.ModuleList(
            [
                Speech2Text2DecoderLayer(config)
...
@add_start_docstrings(
    (
        "The Speech2Text2 Model with a language modeling head. Can be used for"
        " summarization."
    ),
...
@add_start_docstrings(
    (
        "The Speech2Text2 Decoder with a language modeling head. Can be used"
        " as the decoder part of [`EncoderDecoderModel`] and"
