        ...
        **kwargs,
        ...
        if len(self.conv_kernel_sizes) != self.num_conv_layers:
            raise ValueError(
                ...
                " required that `len(config.conv_kernel_sizes)` =="
                " `config.num_conv_layers` but is"
                " `len(config.conv_kernel_sizes) ="
                f" {len(self.conv_kernel_sizes)}`, `config.num_conv_layers ="
                f" {self.num_conv_layers}`."
            )
