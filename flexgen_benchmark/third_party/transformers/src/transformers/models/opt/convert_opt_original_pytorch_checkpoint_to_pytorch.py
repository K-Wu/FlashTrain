...
@torch.no_grad()
def convert_opt_checkpoint(
    checkpoint_path, pytorch_dump_folder_path, config=None
):
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        help=(
            "path to fairseq checkpoint in correct format. You can find all"
            " checkpoints in the correct format here:"
