...
FLAVA_PRETRAINED_CONFIG_ARCHIVE_MAP = {
    "facebook/flava-full": (
        "https://huggingface.co/facebook/flava-full/resolve/main/config.json"
    ),
}
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if image_config_dict is None:
            image_config_dict = {}
            logger.info(
                "image_config_dict is None. initializing the FlavaImageConfig"
                " with default values."
            )
        ...
        if text_config_dict is None:
            text_config_dict = {}
            logger.info(
                "text_config_dict is None. Initializing the FlavaTextConfig"
                " with default values."
            )
        ...
        if multimodal_config_dict is None:
            ...
            logger.info(
                "multimodal_config_dict is None. initializing the"
                " FlavaMultimodalConfig with default values."
            )

        if image_codebook_config_dict is None:
            image_codebook_config_dict = {}
            logger.info(
                "image_codebook_config_dict is None. initializing the"
                " FlavaImageCodebookConfig with default values."
            )
        ...
        self.multimodal_config = FlavaMultimodalConfig(
            **self.multimodal_config_dict
        )
