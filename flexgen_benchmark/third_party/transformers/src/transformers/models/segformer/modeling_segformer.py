...
class SegformerMixFFN(nn.Module):
    def __init__(
        self, config, in_features, hidden_features=None, out_features=None
    ):
        super().__init__()
...
class SegformerDecodeHead(SegformerPreTrainedModel):
    ...
    def forward(self, encoder_hidden_states):
        ...
        all_hidden_states = ()
        for encoder_hidden_state, mlp in zip(
            encoder_hidden_states, self.linear_c
        ):
            if (
