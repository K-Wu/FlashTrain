...
PRETRAINED_VOCAB_FILES_MAP = {
    "vocab_file": {
        "tau/splinter-base": (
            "https://huggingface.co/tau/splinter-base/resolve/main/vocab.txt"
        ),
        "tau/splinter-base-qass": "https://huggingface.co/tau/splinter-base-qass/resolve/main/vocab.txt",
        "tau/splinter-large": (
            "https://huggingface.co/tau/splinter-large/resolve/main/vocab.txt"
        ),
...
class SplinterTokenizer(PreTrainedTokenizer):
    ...
    def build_inputs_with_special_tokens(
        ...
        question_suffix = [self.question_token_id] + [
            self.convert_tokens_to_ids(".")
        ]
        if self.padding_side == "right":
            # Input is question-then-context
            return (
                cls + token_ids_0 + question_suffix + sep + token_ids_1 + sep
            )
        else:
            # Input is context-then-question
            return (
                cls + token_ids_0 + sep + token_ids_1 + question_suffix + sep
            )
