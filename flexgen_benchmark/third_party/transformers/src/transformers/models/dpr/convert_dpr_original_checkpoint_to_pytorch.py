...
class DPRState:
    ...
    def from_type(comp_type: str, *args, **kwargs) -> "DPRState":
        ...
        if comp_type.startswith("r"):
            ...
            raise ValueError(
                "Component type must be either 'ctx_encoder',"
                " 'question_encoder' or 'reader'."
            )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        help=(
            "Type of the component to convert: 'ctx_encoder',"
            " 'question_encoder' or 'reader'."
        ),
    )
    parser.add_argument(
        ...
        type=str,
        help=(
            "Path to the dpr checkpoint file. They can be downloaded from the"
            " official DPR repo https://github.com/facebookresearch/DPR. Note"
            " that in the official repo, both encoders are stored in the"
    ...
    assert args.type is not None, (
        "Please specify the component type of the DPR model to convert:"
        " 'ctx_encoder', 'question_encoder' or 'reader'."
    )
