...
class FlaxBartPreTrainedModel(FlaxPreTrainedModel):
    ...
    @replace_return_docstrings(
        output_type=FlaxBaseModelOutput, config_class=BartConfig
    )
    def encode(
        self,
...
@add_start_docstrings(
    (
        "The bare Bart Model transformer outputting raw hidden-states without"
...
class FlaxBartForCausalLMModule(nn.Module):
    ...
    def setup(self):
        self.model = FlaxBartDecoderWrapper(
