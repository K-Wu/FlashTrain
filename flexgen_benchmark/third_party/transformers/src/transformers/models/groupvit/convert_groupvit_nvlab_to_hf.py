...
def rename_key(name):
    ...
    if "img_encoder.layers" in name:
        name = name.replace(
            "img_encoder.layers", "vision_model.encoder.stages"
        )
    ...
    if "img_projector.linear_hidden." in name:
        name = name.replace(
            "img_projector.linear_hidden.", "visual_projection."
        )
    if "img_projector.linear_out." in name:
        name = name.replace(
            "img_projector.linear_out.", "visual_projection.3."
        )
...
def convert_groupvit_checkpoint(
    ...
    print(
        "Successfully saved processor and model to", pytorch_dump_folder_path
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default=None,
        type=str,
        help="Path to GroupViT checkpoint",
    )
    parser.add_argument(
        "--model_name",
        ...
        type=str,
        help=(
            "Name of the model. Expecting either 'groupvit-gcc-yfcc' or"
    ...
    parser.add_argument(
        ...
        action="store_true",
        help=(
            "Whether or not to push the converted model and processor to the"
            " 🤗 hub using the provided `model_name`."
        ),
    )
