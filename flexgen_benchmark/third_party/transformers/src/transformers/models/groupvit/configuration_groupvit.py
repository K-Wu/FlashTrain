    ...
    def __init__(
        ...
        **kwargs,
        ...
        if num_hidden_layers != sum(depths):
            logger.warning(
                f"Manually setting num_hidden_layers to {num_hidden_layers},"
                " but we expect num_hidden_layers = sum(depth) ="
                f" {sum(depths)}"
            )
        self.num_hidden_layers = num_hidden_layers
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if text_config_dict is None:
            text_config_dict = {}
            logger.info(
                "text_config_dict is None. Initializing the GroupViTTextConfig"
                " with default values."
            )
        ...
        if vision_config_dict is None:
            vision_config_dict = {}
            logger.info(
                "vision_config_dict is None. initializing the"
                " GroupViTVisionConfig with default values."
            )
