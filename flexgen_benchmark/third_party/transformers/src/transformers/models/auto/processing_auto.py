...
class AutoProcessor:
    ...
    def __init__(self):
        raise EnvironmentError(
            "AutoProcessor is designed to be instantiated using the"
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, **kwargs):
        ...
        raise ValueError(
            ...
            f" {pretrained_model_name_or_path}. Can't instantiate a processor,"
            " a tokenizer or a feature extractor for this model. Make sure"
            " the repository contains the files of at least one of those"
            " processing classes."
        )
