...
TF_MODEL_MAPPING = _LazyAutoMapping(
    CONFIG_MAPPING_NAMES, TF_MODEL_MAPPING_NAMES
)
...
class TFAutoModelWithLMHead(_TFAutoModelWithLMHead):
    ...
    def from_config(cls, config):
        warnings.warn(
            (
                "The class `TFAutoModelWithLMHead` is deprecated and will be"
                " removed in a future version. Please use"
                " `TFAutoModelForCausalLM` for causal language models,"
                " `TFAutoModelForMaskedLM` for masked language models and"
