...
@add_start_docstrings(
    (
        "The bare Ernie Model transformer outputting raw hidden-states without"
...
class ErnieForCausalLM(ErniePreTrainedModel):
    ...
    def __init__(self, config):
        ...
        if not config.is_decoder:
            logger.warning(
                "If you want to use `ErnieForCausalLM` as a standalone, add"
                " `is_decoder=True.`"
            )
...
class ErnieForMaskedLM(ErniePreTrainedModel):
    ...
    def __init__(self, config):
        ...
        if config.is_decoder:
            logger.warning(
                "If you want to use `ErnieForMaskedLM` make sure"
