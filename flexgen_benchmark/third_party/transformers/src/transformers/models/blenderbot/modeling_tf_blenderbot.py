    ...
    def from_pretrained(
        ...
        **kwargs,
        ...
        if pretrained_model_name_or_path == "facebook/blenderbot-90M":
            ...
            warnings.warn(
                (
                    "The checkpoint `facebook/blenderbot-90M` is deprecated."
                    " In the future, please use the identical checkpoint"
                    " `facebook/small_blenderbot-90M` with"
                    " `TFBlenderbotSmallForConditionalGeneration.from_pretrained('facebook/small_blenderbot-90M')`"
                    " instead."
                ),
                FutureWarning,
            )
            return TFBlenderbotSmallModel.from_pretrained(
