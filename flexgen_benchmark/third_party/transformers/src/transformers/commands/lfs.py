...
class LfsCommands(BaseTransformersCLICommand):
    ...
    def register_subcommand(parser: ArgumentParser):
        enable_parser = parser.add_parser(
            ...
            help=(
                "Deprecated: use `huggingface-cli` instead. Configure your"
                " repository to enable upload of files > 5GB."
            ),
        )
...
class LfsEnableCommand:
    ...
    def run(self):
        warnings.warn(
            "Managing repositories through transformers-cli is deprecated."
