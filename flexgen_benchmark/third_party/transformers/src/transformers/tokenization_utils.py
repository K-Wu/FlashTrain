        ...
        **kwargs
        ...
        def get_input_ids(text):
            if isinstance(text, str):
                ...
                if is_split_into_words:
                    raise ValueError(
                        f"Input {text} is not valid. Should be a string or a"
                        " list/tuple of strings when"
                        " `is_split_into_words=True`."
                    )
                else:
                    raise ValueError(
                        f"Input {text} is not valid. Should be a string, a"
                        " list/tuple of strings or a list/tuple of integers."
                    )
        ...
        **kwargs
        ...
        def get_input_ids(text):
            if isinstance(text, str):
                ...
                raise ValueError(
                    "Input is not valid. Should be a string, a list/tuple of"
                    " strings or a list/tuple of integers."
                )
