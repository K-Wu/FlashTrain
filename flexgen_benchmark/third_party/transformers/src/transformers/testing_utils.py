...
def custom_tokenizers(test_case):
    ...
    return unittest.skipUnless(
        _run_custom_tokenizers, "test of custom tokenizers"
    )(test_case)
...
def require_bs4(test_case):
    ...
    """
    return unittest.skipUnless(
        is_bs4_available(), "test requires BeautifulSoup4"
    )(test_case)
...
def require_accelerate(test_case):
    ...
    """
    return unittest.skipUnless(
        is_accelerate_available(), "test requires accelerate"
    )(test_case)
...
def require_safetensors(test_case):
    ...
    """
    return unittest.skipUnless(
        is_safetensors_available(), "test requires safetensors"
    )(test_case)
...
def require_rjieba(test_case):
    ...
    """
    return unittest.skipUnless(is_rjieba_available(), "test requires rjieba")(
        test_case
    )
...
def require_tf2onnx(test_case):
    return unittest.skipUnless(
        is_tf2onnx_available(), "test requires tf2onnx"
    )(test_case)


def require_onnx(test_case):
    return unittest.skipUnless(is_onnx_available(), "test requires ONNX")(
        test_case
    )
...
def require_timm(test_case):
    ...
    """
    return unittest.skipUnless(is_timm_available(), "test requires Timm")(
        test_case
    )
...
def require_torch_or_tf(test_case):
    ...
    """
    return unittest.skipUnless(
        is_torch_available() or is_tf_available(),
        "test requires PyTorch or TensorFlow",
    )(test_case)
...
def require_intel_extension_for_pytorch(test_case):
    ...
    return unittest.skipUnless(
        is_ipex_available(),
        (
            "test requires Intel Extension for PyTorch to be installed and"
            " match current PyTorch version, see"
...
def require_torch_scatter(test_case):
    ...
    """
    return unittest.skipUnless(
        is_scatter_available(), "test requires PyTorch scatter"
    )(test_case)
...
def require_torchaudio(test_case):
    ...
    """
    return unittest.skipUnless(
        is_torchaudio_available(), "test requires torchaudio"
    )(test_case)
...
def require_tf(test_case):
    ...
    """
    return unittest.skipUnless(is_tf_available(), "test requires TensorFlow")(
        test_case
    )
...
def require_flax(test_case):
    ...
    """
    return unittest.skipUnless(
        is_flax_available(), "test requires JAX & Flax"
    )(test_case)
...
def require_scipy(test_case):
    ...
    """
    return unittest.skipUnless(is_scipy_available(), "test requires Scipy")(
        test_case
    )
...
def require_tokenizers(test_case):
    ...
    """
    return unittest.skipUnless(
        is_tokenizers_available(), "test requires tokenizers"
    )(test_case)
...
def require_pandas(test_case):
    ...
    """
    return unittest.skipUnless(is_pandas_available(), "test requires pandas")(
        test_case
    )
...
def require_pytesseract(test_case):
    ...
    """
    return unittest.skipUnless(
        is_pytesseract_available(), "test requires PyTesseract"
    )(test_case)
...
def require_vision(test_case):
    ...
    installed.
    """
    return unittest.skipUnless(is_vision_available(), "test requires vision")(
        test_case
    )
...
def require_ftfy(test_case):
    ...
    """
    return unittest.skipUnless(is_ftfy_available(), "test requires ftfy")(
        test_case
    )
...
def require_spacy(test_case):
    ...
    """
    return unittest.skipUnless(is_spacy_available(), "test requires spacy")(
        test_case
    )
...
def require_torchdynamo(test_case):
    ...
    return unittest.skipUnless(
        is_torchdynamo_available(), "test requires TorchDynamo"
    )(test_case)
...
def require_torch_gpu(test_case):
    ...
    return unittest.skipUnless(torch_device == "cuda", "test requires CUDA")(
        test_case
    )
...
def require_torch_bf16_gpu(test_case):
    ...
    return unittest.skipUnless(
        is_torch_bf16_gpu_available(),
        (
            "test requires torch>=1.10, using Ampere GPU or newer arch with"
            " cuda>=11.0"
        ),
    )(test_case)
...
def require_detectron2(test_case):
    ...
    return unittest.skipUnless(
        is_detectron2_available(), "test requires `detectron2`"
    )(test_case)


def require_faiss(test_case):
    """Decorator marking a test that requires faiss."""
    return unittest.skipUnless(is_faiss_available(), "test requires `faiss`")(
        test_case
    )
...
def require_optuna(test_case):
    ...
    """
    return unittest.skipUnless(is_optuna_available(), "test requires optuna")(
        test_case
    )
...
def require_ray(test_case):
    ...
    """
    return unittest.skipUnless(is_ray_available(), "test requires Ray/tune")(
        test_case
    )
...
def require_sigopt(test_case):
    ...
    """
    return unittest.skipUnless(is_sigopt_available(), "test requires SigOpt")(
        test_case
    )
...
def require_wandb(test_case):
    ...
    """
    return unittest.skipUnless(is_wandb_available(), "test requires wandb")(
        test_case
    )
...
def require_soundfile(test_case):
    ...
    """
    return unittest.skipUnless(
        is_soundfile_availble(), "test requires soundfile"
    )(test_case)
...
def require_deepspeed(test_case):
    ...
    """
    return unittest.skipUnless(
        is_deepspeed_available(), "test requires deepspeed"
    )(test_case)
...
def require_fairscale(test_case):
    ...
    """
    return unittest.skipUnless(
        is_fairscale_available(), "test requires fairscale"
    )(test_case)
...
def require_apex(test_case):
    ...
    """
    return unittest.skipUnless(is_apex_available(), "test requires apex")(
        test_case
    )
...
def require_bitsandbytes(test_case):
    ...
    """
    return unittest.skipUnless(
        is_bitsandbytes_available(), "test requires bnb"
    )(test_case)
...
def require_phonemizer(test_case):
    ...
    """
    return unittest.skipUnless(
        is_phonemizer_available(), "test requires phonemizer"
    )(test_case)
...
def require_pyctcdecode(test_case):
    ...
    """
    return unittest.skipUnless(
        is_pyctcdecode_available(), "test requires pyctcdecode"
    )(test_case)
...
def require_librosa(test_case):
    ...
    """
    return unittest.skipUnless(
        is_librosa_available(), "test requires librosa"
    )(test_case)
...
def require_sudachi(test_case):
    ...
    """
    return unittest.skipUnless(
        is_sudachi_available(), "test requires sudachi"
    )(test_case)
...
def require_jumanpp(test_case):
    ...
    """
    return unittest.skipUnless(
        is_jumanpp_available(), "test requires jumanpp"
    )(test_case)
    ...
    def get_auto_remove_tmp_dir(self, tmp_dir=None, before=None, after=None):
        ...
        if tmp_dir is not None:
            ...
            if not tmp_dir.startswith("./"):
                raise ValueError(
                    "`tmp_dir` can only be a relative path, i.e."
                    f" `./some/path`, but received `{tmp_dir}`"
                )
...
def pytest_addoption_shared(parser):
    ...
    if option not in pytest_opt_registered:
        parser.addoption(
            ...
            default=False,
            help=(
                "generate report files. The value of this option is used as a"
                " prefix to report names"
            ),
        )
...
def pytest_terminal_summary_main(tr, id):
        ...
        with open(report_files["durations"], "w") as f:
            ...
            for i, rep in enumerate(dlist):
                if rep.duration < durations_min:
                    f.write(
                        f"{len(dlist)-i} durations < {durations_min} secs were"
                        " omitted"
                    )
                    break
    ...
    tr.reportchars = (  # emulate -rA (used in summary_passes() and short_test_summary())
        "wPpsxXEf"
    )
...
def run_command(command: List[str], return_stdout=False):
    ...
    try:
        ...
        raise SubprocessCallException(
            f"Command `{' '.join(command)}` failed with the following"
            f" error:\n\n{e.output.decode()}"
        ) from e
        ...
        def wrapper(*args, **kwargs):
            ...
            while retry_count < max_attempts:
                try:
                    ...
                    print(
                        (
                            f"Test failed with {err} at try"
                            f" {retry_count}/{max_attempts}."
                        ),
                        file=sys.stderr,
                    )
