...
class Seq2SeqTrainer(Trainer):
    ...
    def prediction_step(
        ...
        if (
            ...
            and self.model.encoder.main_input_name
        ...
        if has_labels:
            ...
            elif gen_kwargs.get("max_new_tokens") is not None and labels.shape[
                -1
            ] < (gen_kwargs["max_new_tokens"] + 1):
                labels = self._pad_tensors_to_max_len(
    ...
    def _pad_tensors_to_max_len(self, tensor, max_length):
        if self.tokenizer is not None and hasattr(
            ...
            if self.model.config.pad_token_id is not None:
                ...
                raise ValueError(
                    "Pad_token_id must be set in the configuration of the"
                    " model, in order to pad tensors"
                )
