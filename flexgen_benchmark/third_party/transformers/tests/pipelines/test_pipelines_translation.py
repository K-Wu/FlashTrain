...
class TranslationPipelineTests(
    ...
    def run_pipeline_test(self, translator, _):
        ...
        self.assertEqual(
            outputs,
            [{"translation_text": ANY(str)}, {"translation_text": ANY(str)}],
        )
    ...
    def test_small_model_pt(self):
        ...
        self.assertEqual(
            ...
            [
                {
                    "translation_text": (
                        "Beide Beide Beide Beide Beide Beide Beide Beide Beide"
                        " Beide Beide Beide Beide Beide Beide Beide Beide"
                    )
                }
            ],
        )
    ...
    def test_en_to_de_pt(self):
        ...
        self.assertEqual(
            ...
            [
                {
                    "translation_text": (
                        "monoton monoton monoton monoton monoton monoton"
                        " monoton monoton monoton monoton urine urine urine"
...
class TranslationNewFormatPipelineTests(unittest.TestCase):
    ...
    def test_multilingual_translation(self):
        ...
        translator = pipeline(
            task="translation", model=model, tokenizer=tokenizer
        )
        ...
        outputs = translator(
            "This is a test", src_lang="en_XX", tgt_lang="ar_AR"
        )
        self.assertEqual(outputs, [{"translation_text": "هذا إختبار"}])

        outputs = translator(
            "This is a test", src_lang="en_XX", tgt_lang="hi_IN"
        )
