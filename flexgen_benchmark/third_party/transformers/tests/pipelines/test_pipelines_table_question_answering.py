...
class TQAPipelineTests(unittest.TestCase, metaclass=PipelineTestCaseMeta):
    ...
    def test_small_model_tf(self):
        ...
        table_querier = TableQuestionAnsweringPipeline(
        ...
        outputs = table_querier(
            ...
            query=[
                ...
                (
                    "Given that the numbers of stars defines if a repository"
                    " is active, what repository is the most active?"
                ),
    ...
    def test_integration_wtq_pt(self):
        ...
        queries = [
            "What repository has the largest number of stars?",
            (
                "Given that the numbers of stars defines if a repository is"
                " active, what repository is the most active?"
            ),
            "What is the number of repositories?",
            "What is the average number of stars?",
            "What is the total amount of stars?",
