...
class ConversationalPipelineTests(
    ...
    def test_integration_torch_conversation(self):
        ...
        conversation_agent = pipeline(
            task="conversational", device=DEFAULT_DEVICE_NUM
        )
        conversation_1 = Conversation(
            "Going to the movies tonight - any suggestions?"
        )
        ...
        conversation_2.add_user_input("Why do you recommend it?")
        result = conversation_agent(
            conversation_2, do_sample=False, max_length=1000
        )
        # Then
    ...
    def test_integration_torch_conversation_truncated_history(self):
        ...
        # When
        result = conversation_agent(
            conversation_1, do_sample=False, max_length=36
        )
        # Then
    ...
    def test_small_model_pt(self):
        ...
        self.assertEqual(
            output,
            Conversation(
                past_user_inputs=["hello"], generated_responses=["Hi"]
            ),
        )
    ...
    def test_integration_torch_conversation_blenderbot_400M_input_ids(self):
        ...
        conversation_1 = Conversation(
            ...
            past_user_inputs=["hello"],
            generated_responses=[
                " Do you like lasagne? It is a traditional Italian dish"
                " consisting of a shepherd's pie."
            ],
        )
        inputs = conversation_agent.preprocess(conversation_1)
        self.assertEqual(
    ...
    def test_integration_torch_conversation_blenderbot_400M(self):
        ...
        self.assertEqual(
            ...
            (
                " Hello! How are you doing today? I just got back from a walk"
                " with my dog."
            ),
        )
        ...
        result = conversation_agent(
            conversation_1, encoder_no_repeat_ngram_size=3
        )
        self.assertEqual(
            result.generated_responses[0],
            (
        ...
        conversation_1 = Conversation(
            "Lasagne   hello   Lasagne is my favorite Italian dish. Do you"
            " like lasagne?   I like lasagne."
        )
        result = conversation_agent(
            conversation_1,
        ...
        self.assertEqual(
            result.generated_responses[0],
            (
                " Me too. I like how it can be topped with vegetables, meats,"
                " and condiments."
            ),
        )
    ...
    def test_integration_torch_conversation_encoder_decoder(self):
        ...
        self.assertEqual(
            ...
            (
                "hi sarah, i live in london as well. do you have any plans for"
                " the weekend?"
            ),
        )
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            (
                "i don't know... i'm not really sure. what movie are you going"
                " to see?"
            ),
        )
        # When
        ...
        self.assertEqual(
            result[0].past_user_inputs[1], "Not yet, what about you?"
        )
        self.assertEqual(
