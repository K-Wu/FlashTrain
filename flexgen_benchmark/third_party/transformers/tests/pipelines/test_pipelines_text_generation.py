...
@require_torch_or_tf
class TextGenerationPipelineTests(
    ...
    def test_small_model_pt(self):
        ...
        self.assertEqual(
            ...
            [
                {
                    "generated_text": (
                        "This is a test ☃ ☃ segmental segmental segmental"
                        " 议议eski eski flutter flutter Lacy oscope. oscope."
                        " FiliFili@@"
                    )
                }
            ],
        ...
        self.assertEqual(
            ...
            [
                [
                    {
                        "generated_text": (
                            "This is a test ☃ ☃ segmental segmental segmental"
                            " 议议eski eski flutter flutter Lacy oscope."
                            " oscope. FiliFili@@"
                        )
                    }
                ],
                [
                    {
                        "generated_text": (
                            "This is a second test ☃ segmental segmental"
                            " segmental 议议eski eski flutter flutter Lacy"
        ...
        text_generator.tokenizer.pad_token_id = (
            text_generator.model.config.eos_token_id
        )
    ...
    def test_small_model_tf(self):
        ...
        self.assertEqual(
            ...
            [
                {
                    "generated_text": (
                        "This is a test FeyFeyFey(Croatis.), s.), Cannes"
                        " Cannes Cannes 閲閲Cannes Cannes Cannes 攵 please,"
                    )
                }
            ],
        )
        ...
        self.assertEqual(
            ...
            [
                [
                    {
                        "generated_text": (
                            "This is a test FeyFeyFey(Croatis.), s.), Cannes"
                            " Cannes Cannes 閲閲Cannes Cannes Cannes 攵"
                            " please,"
                        )
                    }
                ],
                [
                    {
                        "generated_text": (
                            "This is a second test Chieftain Chieftain"
                            " prefecture prefecture prefecture Cannes Cannes"
    ...
    def test_stop_sequence_stopping_criteria(self):
        ...
        self.assertEqual(
            ...
            [
                {
                    "generated_text": (
                        "Hello I believe in fe fe fe fe fe fe fe fe fe fe"
                        " fe fe"
                    )
                }
            ],
    ...
    def run_pipeline_test(self, text_generator, _):
        ...
        self.assertTrue(
            outputs[0]["generated_text"].startswith("This is a test")
        )
    ...
    def test_small_model_pt_bloom_accelerate(self):
        ...
        self.assertEqual(
            ...
            [
                {
                    "generated_text": (
                        "This is a test test test test test test test test"
