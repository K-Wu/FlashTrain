...
class FeatureExtractionPipelineTests(
    ...
    def test_tokenization_small_model_pt(self):
        ...
        outputs = feature_extractor(
            "This is a test", tokenize_kwargs=tokenize_kwargs
        )
    ...
    def get_test_pipeline(self, model, tokenizer, feature_extractor):
        if tokenizer is None:
            ...
            self.skipTest(
                "This is a bimodal model, we need to find a more consistent"
                " way to switch on those models."
            )
            return
