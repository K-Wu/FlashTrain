...
class QAPipelineTests(unittest.TestCase, metaclass=PipelineTestCaseMeta):
    ...
    def run_pipeline_test(self, question_answerer, _):
        ...
        with self.assertRaises(ValueError):
            question_answerer(
                question="", context="HuggingFace was founded in Paris."
            )
        with self.assertRaises(ValueError):
            question_answerer(
    ...
    def test_large_model_issue(self):
        ...
        outputs = qa_pipeline(
            {
                "context": (
                    "Yes Bank founder Rana Kapoor has approached the Bombay"
                    " High Court, challenging a special court's order from"
                    " August this year that had remanded him in police custody"
                    " for a week in a multi-crore loan fraud case. Kapoor, who"
                    " is currently lodged in Taloja Jail, is an accused in the"
                    " loan fraud case and some related matters being probed by"
                    " the CBI and Enforcement Directorate. A single bench"
                    " presided over by Justice S K Shinde on Tuesday posted"
                    " the plea for further hearing on October 14. In his plea"
                    " filed through advocate Vijay Agarwal, Kapoor claimed"
                    " that the special court's order permitting the CBI's"
                    " request for police custody on August 14 was illegal and"
                    " in breach of the due process of law. Therefore, his"
                    " police custody and subsequent judicial custody in the"
                    " case were all illegal. Kapoor has urged the High Court"
                    " to quash and set aside the special court's order dated"
                    " August 14. As per his plea, in August this year, the CBI"
                    " had moved two applications before the special court, one"
                    " seeking permission to arrest Kapoor, who was already in"
                    " judicial custody at the time in another case, and the"
                    " other, seeking his police custody. While the special"
                    " court refused to grant permission to the CBI to arrest"
                    " Kapoor, it granted the central agency's plea for his"
                    " custody. Kapoor, however, said in his plea that before"
                    " filing an application for his arrest, the CBI had not"
                    " followed the process of issuing him a notice under"
                    " Section 41 of the CrPC for appearance before it. He"
                    " further said that the CBI had not taken prior sanction"
                    " as mandated under section 17 A of the Prevention of"
                    " Corruption Act for prosecuting him. The special court,"
                    " however, had said in its order at the time that as"
                    " Kapoor was already in judicial custody in another case"
                    " and was not a free man the procedure mandated under"
                    " Section 41 of the CrPC need not have been adhered to as"
                    " far as issuing a prior notice of appearance was"
                    " concerned. ADVERTISING It had also said that case"
                    " records showed that the investigating officer had taken"
                    " an approval from a managing director of Yes Bank before"
                    " beginning the proceedings against Kapoor and such a"
                    " permission was a valid sanction. However, Kapoor in his"
                    " plea said that the above order was bad in law and sought"
                    " that it be quashed and set aside. The law mandated that"
                    " if initial action was not in consonance with legal"
                    " procedures, then all subsequent actions must be held as"
                    " illegal, he said, urging the High Court to declare the"
                    " CBI remand and custody and all subsequent proceedings"
                    " including the further custody as illegal and void"
                    " ab-initio. In a separate plea before the High Court,"
                    " Kapoor's daughter Rakhee Kapoor-Tandon has sought"
                    " exemption from in-person appearance before a special"
                    " PMLA court. Rakhee has stated that she is a resident of"
                    " the United Kingdom and is unable to travel to India"
                    " owing to restrictions imposed due to the COVID-19"
                    " pandemic. According to the CBI, in the present case,"
                    " Kapoor had obtained a gratification or pecuniary"
                    " advantage of ₹ 307 crore, and thereby caused Yes Bank a"
                    " loss of ₹ 1,800 crore by extending credit facilities to"
                    " Avantha Group, when it was not eligible for the same"
                ),
...
class QuestionAnsweringArgumentHandlerTests(unittest.TestCase):
    def test_argument_handler(self):
        ...
        normalized = qa(
            [{"question": Q, "context": C}, {"question": Q, "context": C}]
        )
        self.assertEqual(type(normalized), list)
        self.assertEqual(len(normalized), 2)
        self.assertEqual({type(el) for el in normalized}, {SquadExample})
