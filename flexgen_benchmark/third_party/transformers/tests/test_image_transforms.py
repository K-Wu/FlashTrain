...
class ImageTransformsTester(unittest.TestCase):
    ...
    def test_get_resize_output_image_size(self):
        ...
        self.assertEqual(
            get_resize_output_image_size(image, (10, 20)), (10, 20)
        )
        self.assertEqual(
            get_resize_output_image_size(image, [10, 20]), (10, 20)
        )
        self.assertEqual(
            get_resize_output_image_size(
                image, (10, 20), default_to_square=True
            ),
            (10, 20),
        )
        ...
        self.assertEqual(
            get_resize_output_image_size(image, 20, default_to_square=False),
            (25, 20),
        )
    ...
    def test_center_crop(self):
        ...
        cropped_image = center_crop(
            image, (120, 60), data_format="channels_last"
        )
        ...
        cropped_image = center_crop(
            image, (300, 260), data_format="channels_last"
        )
        self.assertIsInstance(cropped_image, np.ndarray)
