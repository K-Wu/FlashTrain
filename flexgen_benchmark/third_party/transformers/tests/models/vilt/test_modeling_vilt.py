...
@unittest.skipIf(
    ...
    "Vilt is only available in torch v1.10+",
)
class ViltModelTest(ModelTesterMixin, unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.config_tester = ConfigTester(
            self, config_class=ViltConfig, hidden_size=37
        )
    ...
    def test_attention_outputs(self):
        ...
        for model_class in self.all_model_classes:
            ...
            if model_class.__name__ == "ViltForImagesAndTextClassification":
                self.assertEqual(
                    len(self_attentions), self.model_tester.num_images
                )
                self.assertEqual(
                    len(self_attentions[0]),
    ...
    def test_hidden_states_output(self):
        def check_hidden_states_output(inputs_dict, config, model_class):
            ...
            if model_class.__name__ == "ViltForImagesAndTextClassification":
                ...
                self.assertEqual(
                    len(hidden_states), self.model_tester.num_images
                )
...
class ViltForImagesAndTextClassificationModelTest(
    ViltModelTest, unittest.TestCase
):
    all_model_classes = (
...
class ViltModelIntegrationTest(unittest.TestCase):
    ...
    def test_inference_masked_lm(self):
        ...
        expected_slice = torch.tensor([-12.5061, -12.5123, -12.5174]).to(
            torch_device
        )
        self.assertTrue(
    ...
    def test_inference_visual_question_answering(self):
        ...
        expected_slice = torch.tensor([-15.9495, -18.1472, -10.3041]).to(
            torch_device
        )
    ...
    def test_inference_natural_language_visual_reasoning(self):
        ...
        dataset = load_dataset(
            "hf-internal-testing/fixtures_nlvr2", split="test"
        )
