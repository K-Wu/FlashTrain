...
class FNetModelTester:
    ...
    def create_and_check_for_sequence_classification(
        ...
        model.eval()
        result = model(
            input_ids, token_type_ids=token_type_ids, labels=sequence_labels
        )
        self.parent.assertEqual(
...
class FNetModelIntegrationTest(unittest.TestCase):
    ...
    def test_inference_long_sentence(self):
        ...
        self.assertEqual(
            predictions_mask_1.split(" "),
            ["man", "child", "teacher", "woman", "model"],
        )
        self.assertEqual(
            predictions_mask_2.split(" "),
            ["work", "wife", "job", "story", "name"],
        )
