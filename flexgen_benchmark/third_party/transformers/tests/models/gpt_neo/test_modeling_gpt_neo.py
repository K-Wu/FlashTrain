...
class GPTNeoModelTest(
    ...
    def setUp(self):
        ...
        self.config_tester = ConfigTester(
            self, config_class=GPTNeoConfig, n_embd=37
        )
...
class GPTNeoModelLanguageGenerationTest(unittest.TestCase):
    ...
    def test_gpt_neo_sample(self):
        ...
        EXPECTED_OUTPUT_STR = (
            "Today is a nice day and if you don’t get the memo here is what"
            " you can"
        )
    ...
    def test_batch_generation(self):
        ...
        expected_output_sentence = [
            (
                "Hello, my dog is a little bit of a kitty. She is a very sweet"
                " and loving"
            ),
