...
class EncoderDecoderMixin:
    ...
    def check_encoder_decoder_model_from_pretrained(
        ...
        **kwargs
        ...
        enc_dec_model = (
            SpeechEncoderDecoderModel.from_encoder_decoder_pretrained(**kwargs)
        )
        enc_dec_model.to(torch_device)
        outputs_encoder_decoder = enc_dec_model(
            input_values=input_values,
...
class Wav2Vec2BertModelTest(EncoderDecoderMixin, unittest.TestCase):
    ...
    def prepare_config_and_inputs(self):
        ...
        encoder_config_and_inputs = (
            wav2vec2_model_tester.prepare_config_and_inputs()
        )
...
class Speech2TextBertModelTest(EncoderDecoderMixin, unittest.TestCase):
    ...
    def prepare_config_and_inputs(self):
        ...
        encoder_config_and_inputs = (
            speech2text_model_tester.prepare_config_and_inputs()
        )
        decoder_config_and_inputs = (
            bert_model_tester.prepare_config_and_inputs_for_decoder()
        )
