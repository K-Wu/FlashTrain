...
class OwlViTProcessorTest(unittest.TestCase):
    ...
    def test_save_load_pretrained_default(self):
        ...
        self.assertEqual(
            tokenizer_slow.get_vocab(), tokenizer_fast.get_vocab()
        )
        ...
        self.assertIsInstance(
            processor_slow.feature_extractor, OwlViTFeatureExtractor
        )
        self.assertIsInstance(
            processor_fast.feature_extractor, OwlViTFeatureExtractor
        )
    ...
    def test_save_load_pretrained_additional_features(self):
        ...
        self.assertIsInstance(
            processor.feature_extractor, OwlViTFeatureExtractor
        )
    ...
    def test_tokenizer(self):
        ...
        for key in encoded_tok.keys():
            self.assertListEqual(
                encoded_tok[key][0].tolist(),
                encoded_processor[key][0].tolist(),
            )
    ...
    def test_processor_with_text_list(self):
        ...
        seq_length = 16
        self.assertListEqual(
            list(inputs.keys()), ["input_ids", "attention_mask"]
        )
