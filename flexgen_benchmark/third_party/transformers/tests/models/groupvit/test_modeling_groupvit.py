...
class GroupViTVisionModelTest(ModelTesterMixin, unittest.TestCase):
    ...
    @unittest.skip(
        reason=(
            "GroupViTVisionModel has no base class and is not available in"
            " MODEL_MAPPING"
        )
    )
...
class GroupViTTextModelTest(ModelTesterMixin, unittest.TestCase):
    ...
    @unittest.skip(
        reason=(
            "GroupViTTextModel has no base class and is not available in"
            " MODEL_MAPPING"
        )
    )
    def test_save_load_fast_init_from_base(self):
...
class GroupViTModelTest(ModelTesterMixin, unittest.TestCase):
    ...
    @unittest.skip(
        reason="GroupViTModel does not have input/output embeddings"
    )
    def test_model_common_attributes(self):
        pass
