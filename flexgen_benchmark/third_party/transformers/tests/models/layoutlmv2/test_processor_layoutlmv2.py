    ...
    def test_save_load_pretrained_default(self):
        ...
        for tokenizer in tokenizers:
            ...
            self.assertIsInstance(
                processor.tokenizer,
                (LayoutLMv2Tokenizer, LayoutLMv2TokenizerFast),
            )
...
class LayoutLMv2ProcessorIntegrationTests(unittest.TestCase):
    ...
    def test_processor_case_1(self):
        ...
        for tokenizer in tokenizers:
            ...
            input_processor = processor(
                images, padding=True, return_tensors="pt"
            )
    ...
    def test_processor_case_2(self):
        ...
        for tokenizer in tokenizers:
            ...
            self.assertListEqual(
                input_processor.bbox[1].tolist(), expected_bbox
            )
    ...
    def test_processor_case_3(self):
        ...
        for tokenizer in tokenizers:
            ...
            self.assertListEqual(
                input_processor.labels[1].tolist(), expected_labels
            )
    ...
    def test_processor_case_4(self):
        ...
        for tokenizer in tokenizers:
            ...
            input_processor = processor(
                images[0], question, return_tensors="pt"
            )
            ...
            # this was obtained with Tesseract 4.1.1
            expected_decoding = (
                "[CLS] what's the time [SEP] 7 itc limited report and accounts"
                " 2013 itc ’ s [SEP]"
            )
            decoding = processor.decode(input_processor.input_ids[1].tolist())
            self.assertSequenceEqual(decoding, expected_decoding)
    ...
    def test_processor_case_5(self):
        ...
        for tokenizer in tokenizers:
            ...
            # verify input_ids
            expected_decoding = (
                "[CLS] what's his name? [SEP] hello world [SEP]"
            )
            decoding = processor.decode(
                input_processor.input_ids.squeeze().tolist()
            )
            ...
            # verify input_ids
            expected_decoding = (
                "[CLS] how old is he? [SEP] hello world [SEP] [PAD] [PAD]"
                " [PAD]"
            )
            decoding = processor.decode(input_processor.input_ids[0].tolist())
            self.assertSequenceEqual(decoding, expected_decoding)
            ...
            expected_decoding = (
                "[CLS] what's the time [SEP] my name is niels [SEP]"
            )
            decoding = processor.decode(input_processor.input_ids[1].tolist())
            self.assertSequenceEqual(decoding, expected_decoding)
            ...
            self.assertListEqual(
                input_processor.bbox[1].tolist()[-5:], expected_bbox
            )
