...
class DetrModelTester:
    ...
    def create_and_check_detr_model(
...
class DetrModelIntegrationTests(unittest.TestCase):
    ...
    def test_inference_no_head(self):
        model = DetrModel.from_pretrained("facebook/detr-resnet-50").to(
            torch_device
        )
    ...
    def test_inference_panoptic_segmentation_head(self):
        ...
        expected_shape_masks = torch.Size(
            (1, model.config.num_queries, 200, 267)
        )
