...
class SEWModelTest(ModelTesterMixin, unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.config_tester = ConfigTester(
            self, config_class=SEWConfig, hidden_size=37
        )
...
class SEWModelIntegrationTest(unittest.TestCase):
    ...
    def test_inference_pretrained_batched(self):
        model = SEWModel.from_pretrained("asapp/sew-tiny-100k").to(
            torch_device
        )
    ...
    def test_inference_ctc_batched(self):
        ...
        EXPECTED_TRANSCRIPTIONS = [
            ...
            (
                "swet covered brian's body trickling into the tightloine closs"
                " hat was the only garment he wore"
            ),
        ]
