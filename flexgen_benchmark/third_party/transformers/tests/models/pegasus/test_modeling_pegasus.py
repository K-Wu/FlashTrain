...
class PegasusModelTester:
    ...
    def create_and_check_decoder_model_past_large_inputs(
        ...
        model = (
            PegasusModel(config=config).get_decoder().to(torch_device).eval()
        )
...
class PegasusXSUMIntegrationTest(AbstractSeq2SeqIntegrationTest):
    ...
    tgt_text = [
        ...
        (
            "Pop group N-Dubz have revealed they were surprised to get four"
            " nominations for this year's Mobo Awards."
        ),
    ]
