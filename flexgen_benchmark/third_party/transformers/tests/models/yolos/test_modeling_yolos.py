...
class YolosModelTester:
    def __init__(
        ...
        num_patches = (image_size[1] // patch_size) * (
    ...
    def create_and_check_for_object_detection(
        ...
        self.parent.assertEqual(
            result.pred_boxes.shape,
            (self.batch_size, self.num_detection_tokens, 4),
        )
...
class YolosModelTest(ModelTesterMixin, unittest.TestCase):
    ...
    def test_for_object_detection(self):
        config_and_inputs = self.model_tester.prepare_config_and_inputs()
        self.model_tester.create_and_check_for_object_detection(
            *config_and_inputs
        )
