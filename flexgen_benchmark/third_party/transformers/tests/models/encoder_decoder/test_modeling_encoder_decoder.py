    ...
    def create_and_check_encoder_decoder_shared_weights(
        ...
        **kwargs
        ...
        (
            tied_encoder_model,
            tied_decoder_model,
        ) = self.get_encoder_decoder_model(config, decoder_config)
...
@require_torch
class BertGenerationEncoderDecoderModelTest(
...
@require_torch
class ProphetNetEncoderDecoderModelTest(
    EncoderDecoderMixin, unittest.TestCase
):
    def get_encoder_decoder_model(self, config, decoder_config):
        encoder_model = BertModel(config)
