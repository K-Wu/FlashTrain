...
class Wav2Vec2ConformerUtilsTest(unittest.TestCase):
    ...
    def test_compute_perplexity(self):
        ...
        ppl = Wav2Vec2ConformerGumbelVectorQuantizer._compute_perplexity(
            probs, mask
        )
...
class Wav2Vec2ConformerModelIntegrationTest(unittest.TestCase):
    ...
    def test_inference_ctc_normal_batched_rel_pos(self):
        ...
        EXPECTED_TRANSCRIPTIONS = [
            ...
            (
                "sweat covered brion's body trickling into the tight loincloth"
                " that was the only garment he wore"
            ),
        ]
    ...
    def test_inference_pretrained(self):
        ...
        model_rand = (
            Wav2Vec2ConformerForPreTraining(config).to(torch_device).eval()
        )
