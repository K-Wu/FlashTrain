...
class TFGPT2ModelTester:
    ...
    def create_and_check_gpt2_model_past(
        ...
        output_from_no_past = model(
            next_input_ids, token_type_ids=next_token_type_ids
        )["last_hidden_state"]
        ...
        random_slice_idx = int(
            ids_tensor((1,), shape_list(output_from_past)[-1])
        )
    ...
    def create_and_check_gpt2_model_attention_mask_past(
        ...
        output_from_past = model(
            next_tokens, past=past, attention_mask=attn_mask
        )["last_hidden_state"]
...
class TFGPT2ModelLanguageGenerationTest(unittest.TestCase):
    ...
    def test_lm_generate_greedy_distilgpt2_batch_special(self):
        ...
        expected_output_string = [
            (
                "Today is a beautiful day and I am so happy to be able take"
                " part in this amazing event."
            ),
            (
                "Yesterday was a very interesting time for the world to see"
                " how much of this is"
            ),
        ]
    ...
    def test_lm_generate_sample_distilgpt2_batch_special(self):
        ...
        expected_output_string = [
            (
                "Today is a beautiful day and we will make you feel very"
                " hot/terrific in all your"
            ),
            (
                "Yesterday was known by national television networks as Le Big"
                " Show or Wild Dog Jeopard"
            ),
        ]
        self.assertListEqual(output_strings, expected_output_string)
    ...
    def test_lm_generate_greedy_distilgpt2_beam_search_special(self):
        ...
        expected_output_string = [
            ...
            (
                "Yesterday was the first time that a person has been arrested"
    ...
    def test_lm_generate_distilgpt2_left_padding(self):
        ...
        expected_output_string = (
            "Today is a beautiful day and I am so happy to be able take part"
        ...
        output_ids = model.generate(
            **input_ids, **generation_kwargs, max_length=27
        )
        output_strings = tokenizer.batch_decode(
            output_ids, skip_special_tokens=True
        )
    ...
    def test_lm_generate_gpt2_greedy_xla(self):
        ...
        expected_output_strings = [
            (
                "The dog was found in a field near the intersection of West"
                " and West Streets.\n\nThe"
            ),
            (
                "The flying machine is a small, lightweight, and lightweight"
                " aircraft that can be used for any type of"
            ),
        ]
        input_ids = tokenizer(sentences, return_tensors="tf", padding=True)
    ...
    def test_lm_generate_gpt2_sample_xla(self):
        ...
        with tf.device(":/CPU:0"):
            ...
            expected_output_string = [
                (
                    "The dog owner asked why did our vet decide there needed"
                    " to be extra ventilation inside because most puppies"
                ),
                (
                    "The flying machine was made by an artist who found it"
                    " difficult to control it as it did not use"
                ),
            ]
            expected_output_string_xla = [
                (
                    "The dog has been named in connection with the murder of a"
                    " 20-year-old man in"
                ),
                (
                    "The flying machine is a new and improved system to"
                    " operate and operate a new system and system system"
                    " system"
                ),
            ]
            ...
            output_ids = model.generate(
                **input_ids, do_sample=True, seed=[7, 0]
            )
            output_strings = tokenizer.batch_decode(
                output_ids, skip_special_tokens=True
            )
    ...
    def test_lm_generate_gpt2_beam_search_xla(self):
        ...
        expected_output_strings = [
            (
                "The dog was found in the backyard of a home in the 6500 block"
                " of South Main Street"
            ),
            (
                "The flying machine is a very powerful machine, but it's not a"
                " very powerful machine. It's"
            ),
        ]
        input_ids = tokenizer(sentences, return_tensors="tf", padding=True)
