...
class GPT2ModelTest(
    ...
    def test_batch_generation(self):
        ...
        expected_output_sentence = [
            (
                "Hello, my dog is a little bit of a mess. I'm not sure if he's"
                " going"
            ),
...
class GPT2ModelLanguageGenerationTest(unittest.TestCase):
    ...
    def test_gpt2_sample(self):
        ...
        EXPECTED_OUTPUT_STR = (
            "Today is a nice day and if you don't know anything about the"
            " state of play during your holiday"
        )
