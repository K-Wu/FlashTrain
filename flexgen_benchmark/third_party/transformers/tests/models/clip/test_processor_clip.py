...
class CLIPProcessorTest(unittest.TestCase):
    ...
    def test_save_load_pretrained_default(self):
        ...
        processor_slow = CLIPProcessor.from_pretrained(
        ...
        self.assertIsInstance(
            processor_slow.feature_extractor, CLIPFeatureExtractor
        )
        self.assertIsInstance(
            processor_fast.feature_extractor, CLIPFeatureExtractor
        )
    ...
    def test_save_load_pretrained_additional_features(self):
        ...
        self.assertIsInstance(
            processor.feature_extractor, CLIPFeatureExtractor
        )
