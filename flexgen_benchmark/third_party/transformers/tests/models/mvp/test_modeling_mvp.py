...
class MvpModelTester:
    ...
    def prepare_config_and_inputs(self):
        ...
        inputs_dict = prepare_mvp_inputs_dict(
...
class MvpStandaloneDecoderModelTest(
    ...
    all_model_classes = (
        (MvpDecoder, MvpForCausalLM) if is_torch_available() else ()
    )
    all_generative_model_classes = (
        (MvpForCausalLM,) if is_torch_available() else ()
    )
    fx_comptatible = True
    test_pruning = False
    is_encoder_decoder = False
    ...
    def setUp(
        ...
        self.model_tester = MvpStandaloneDecoderModelTester(
