...
class Speech2TextModelTester:
    ...
    def create_and_check_decoder_model_past_large_inputs(
        ...
        model = (
            Speech2TextModel(config=config)
            .get_decoder()
            .to(torch_device)
            .eval()
        )
    ...
    def check_encoder_decoder_model_standalone(self, config, inputs_dict):
        ...
        with tempfile.TemporaryDirectory() as tmpdirname:
            ...
            encoder = Speech2TextEncoder.from_pretrained(tmpdirname).to(
                torch_device
            )
        ...
        with tempfile.TemporaryDirectory() as tmpdirname:
            ...
            decoder = Speech2TextDecoder.from_pretrained(tmpdirname).to(
                torch_device
            )
...
class Speech2TextModelTest(
    ...
    def test_generate_fp16(self):
        ...
        model = (
            Speech2TextForConditionalGeneration(config).eval().to(torch_device)
        )
...
class Speech2TextModelIntegrationTests(unittest.TestCase):
    ...
    def test_generation_librispeech(self):
        ...
        EXPECTED_TRANSCRIPTIONS = [
            "mister quilter is the apostle of the middle classes and we are"
    ...
    def test_generation_librispeech_batched(self):
        ...
        EXPECTED_TRANSCRIPTIONS = [
            (
                "mister quilter is the apostle of the middle classes and we"
            ...
            (
                ...
                " christmas and roast beef looming before us similes drawn"
                " from eating and its results occur most readily to the mind"
            ),
            (
                "he has grave doubts whether sir frederick leyton's work is"
                " really greek after all and can discover in it but little of"
                " rocky ithaca"
            ),
        ]
