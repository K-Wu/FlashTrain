...
class GLPNFeatureExtractionTest(
    ...
    feature_extraction_class = (
        GLPNFeatureExtractor if is_vision_available() else None
    )
    ...
    def test_call_pil(self):
        ...
        self.assertTrue(
            encoded_images.shape[-1] % self.feature_extract_tester.size_divisor
            == 0
        )
        self.assertTrue(
            encoded_images.shape[-2] % self.feature_extract_tester.size_divisor
            == 0
        )
