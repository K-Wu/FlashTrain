    ...
    def get_expected_values(self, image_inputs, batched=False):
        ...
        if not batched:
            ...
            for image in image_inputs:
                expected_height, expected_width = self.get_expected_values(
                    [image]
                )
...
class ConditionalDetrFeatureExtractionTest(
    ...
    feature_extraction_class = (
        ConditionalDetrFeatureExtractor if is_vision_available() else None
    )

    def setUp(self):
        self.feature_extract_tester = ConditionalDetrFeatureExtractionTester(
            self
        )
    ...
    def test_call_pil(self):
        ...
        (
            expected_height,
            expected_width,
        ) = self.feature_extract_tester.get_expected_values(
    ...
    def test_equivalence_pad_and_create_pixel_mask(self):
        ...
        encoded_images_with_method = (
            feature_extractor_1.pad_and_create_pixel_mask(
                image_inputs, return_tensors="pt"
            )
        )
    ...
    def test_call_pytorch_with_coco_detection_annotations(self):
        ...
        with open(
            "./tests/fixtures/tests_samples/COCO/coco_annotations.txt", "r"
        ) as f:
        ...
        self.assertEqual(
            encoding["labels"][0]["boxes"].shape, expected_boxes_shape
        )
    ...
    def test_call_pytorch_with_coco_panoptic_annotations(self):
        ...
        masks_path = pathlib.Path(
            "./tests/fixtures/tests_samples/COCO/coco_panoptic"
        )

        # encode them
        feature_extractor = ConditionalDetrFeatureExtractor(
