...
class BloomTokenizationTest(TokenizerTesterMixin, unittest.TestCase):
    ...
    def test_encodings_from_sample_data(self):
        ...
        computed_tokens = tokenizer.batch_encode_plus(INPUT_SENTENCES)[
            "input_ids"
        ]
        ...
        for tokenizer, pretrained_name, kwargs in self.tokenizers_list:
            with self.subTest(
                ...
                try:
                    ...
                    self.fail(
                        "Bloom Tokenizer should be able to deal with padding"
                    )
    ...
    def test_encodings_from_xnli_dataset(self):
        ...
        tokenizer = self.get_rust_tokenizer()
        ds = load_dataset(
            "xnli", "all_languages", split="test", streaming=True
        )
