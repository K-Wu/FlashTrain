...
class FlavaProcessorTest(unittest.TestCase):
    ...
    def test_save_load_pretrained_default(self):
        ...
        processor_slow = FlavaProcessor.from_pretrained(
        ...
        self.assertIsInstance(
            processor_slow.feature_extractor, FlavaFeatureExtractor
        )
        self.assertIsInstance(
            processor_fast.feature_extractor, FlavaFeatureExtractor
        )
    ...
    def test_save_load_pretrained_additional_features(self):
        ...
        self.assertIsInstance(
            processor.feature_extractor, FlavaFeatureExtractor
        )
