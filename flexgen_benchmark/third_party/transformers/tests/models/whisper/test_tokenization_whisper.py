...
class SpeechToTextTokenizerMultilinguialTest(unittest.TestCase):
    ...
    transcript = (
        "'<|startoftranscript|> <|en|> <|transcribe|> <|notimestamps|>  Nor is"
        " Mr. Quilters manner less interesting than his matter.<|endoftext|>'"
    )
    clean_transcript = (
    ...
    def test_tokenizer_equivalence(self):
        ...
        multilingual_tokenizer = WhisperTokenizer.from_pretrained(
            "openai/whisper-tiny", language="ko"
        )
        gpt2_tokenizer = WhisperTokenizer.from_pretrained(
    ...
    def test_tokenizer_special(self):
        ...
        text = (
            "<|startoftranscript|>Hey! How are you feeling? J'ai l'impression"
            " que 郷さん est prêt<|endoftext|>"
        )
        ...
        self.assertEqual(
            text, multilingual_tokenizer.decode(multilingual_tokens)
        )
        ...
        EXPECTED_JAP = (
            "Hey! How are you feeling? J'ai l'impression que 郷さん est prêt"
        )
    ...
    def test_batch_encoding(self):
        ...
        batch = [
            "<|en|><|notimestamps|>",
            "<|en|><|notimestamps|>I am sure that",
        ]
