...
class WhisperFeatureExtractionTest(
    ...
    def test_feat_extract_from_and_save_pretrained(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdirname:
            ...
            feat_extract_second = (
                self.feature_extraction_class.from_pretrained(tmpdirname)
            )
    ...
    def test_call(self):
        ...
        self.assertTrue(
            input_features.shape[-1] == feature_extractor.nb_max_frames
        )
        self.assertTrue(
            input_features.shape[-2] == feature_extractor.feature_size
        )
        ...
        np_speech_inputs_truncated = [
            np.asarray(speech_input)
            for speech_input in speech_inputs_truncated
        ]
