...
class MCTCTModelTester:
    ...
    def create_and_check_model_for_ctc(
...
class MCTCTModelTest(ModelTesterMixin, unittest.TestCase):
    all_model_classes = (
        (MCTCTForCTC, MCTCTModel) if is_torch_available() else ()
    )
    test_pruning = False
...
class MCTCTModelIntegrationTest(unittest.TestCase):
    ...
    def test_inference_ctc_normal_batched(self):
        ...
        EXPECTED_TRANSCRIPTIONS = [
            ...
            (
                ...
                ' clossa was the only germent huor."'
            ),
        ]
        self.assertListEqual(predicted_trans, EXPECTED_TRANSCRIPTIONS)
    ...
    def test_inference_ctc_robust_batched(self):
        ...
        EXPECTED_TRANSCRIPTIONS = [
            ...
            (
                "\"the cadona's chest still-dripping bloodthe acofis"
                " overstrained eyes, even the soring arena around him with"
                " thousands of spectators retrivialities not worth-thinking"
                " about."
            ),
            (
