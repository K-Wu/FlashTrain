...
class Wav2Vec2PhonemeCTCTokenizerTest(TokenizerTesterMixin, unittest.TestCase):
    ...
    def setUp(self):
        ...
        vocab = (
            "<s> <pad> </s> <unk> n s t ə l a i k d m ɛ ɾ e ɪ p o ɐ z ð f j v"
            " b ɹ ʁ ʊ iː r w ʌ u ɡ æ aɪ ʃ h ɔ ɑː ŋ ɚ eɪ β uː y ɑ̃ oʊ ᵻ eː θ aʊ"
            " ts oː ɔ̃ ɣ ɜ ɑ dʒ əl x ɜː ç ʒ tʃ ɔː ɑːɹ ɛ̃ ʎ ɔːɹ ʋ aː ɕ œ ø oːɹ ɲ"
            " yː ʔ iə i5 s. tɕ ?? nʲ ɛː œ̃ ɭ ɔø ʑ tʲ ɨ ɛɹ ts. rʲ ɪɹ ɭʲ i.5 ɔɪ q"
            " sʲ u5 ʊɹ iɜ a5 iɛ5 øː ʕ ja əɜ th ɑ5 oɪ dʲ ə5 tɕh ts.h mʲ ɯ dʑ vʲ"
            " e̞ tʃʲ ei5 o5 onɡ5 ɑu5 iɑ5 ai5 aɪɚ kh ə1 ʐ i2 ʉ ħ t[ aɪə ʲ ju ə2"
            " u2 oɜ pː iɛɜ ou5 y5 uɜ tː uo5 d[ uoɜ tsh ɑɜ ɵ i̪5 uei5 ɟ aɜ ɑɨ"
            " i.ɜ eʊ o2 ɐ̃ ä pʲ kʲ n̩ ɒ ph ɑu2 uɨ əɪ ɫ ɬ yɜ bʲ ɑ2 s̪ aiɜ χ ɐ̃ʊ̃ 1"
            " ə4 yæɜ a2 ɨː t̪ iouɜ ũ onɡɜ aɨ iɛ2 ɔɨ ɑuɜ o̞ ei2 iou2 c kː y2 ɖ oe"
            ' dˤ yɛɜ əʊ S ɡʲ onɡ2 u" eiɜ ʈ ɯᵝ iou5 dZ r̝̊ i.2 tS s^ ʝ yə5 iɑɜ'
            " uə5 pf ɨu iɑ2 ou2 ər2 fʲ ai2 r̝ uəɜ ɳ əɨ ua5 uɪ ɽ bː yu5 uo2 yɛ5"
            " l̩ ɻ ərɜ ʂ i̪2 ouɜ uaɜ a. a.ː yæ5 dː r̩ ee ɪu ər5 i̪ ɜ æi u: i.ː t^"
            " o1 ɪ^ ai ueiɜ æː ɛɪ eə i. ɴ ie ua2 ɑ1 o4 tʃː o: ɑ: u1 N i̪1 au"
            " yæ2 u. qː yəɜ y: kʰ tʃʰ iʊ sx õ uo tʰ uai5 bʰ u.ː uə2 ʊə d^ s̪ː"
            " yiɜ dʰ r. oe: i1 ɟː yu2 nʲʲ i̪4 uei2 tsʲ ɸ ĩ ɑ4 t̪ː eɑ u4 e: tsː"
            " ʈʰ ɡʰ ɯɯ dʒʲ ʂʲ X ɵː uaiɜ tɕʲ ã t^ː ẽː yɛ2 cː i.1 ɛʊ dˤdˤ dʒː i4"
            " ɡː yi ɕʲ ɟʰ pʰ dʑʲ yuɜ ua1 ua4 æiː ɐɐ ui iou1 ʊː a1 iou4 cʰ iɛ1"
            " yə2 ɖʰ ẽ ʒʲ ää ər4 iːː ɪː iɑ1 ər1 œː øi ɪuː cʰcʰ əː1 iː1 ũ kʰː"
            " o̞o̞ xʲ ou1 iɛ4 e̞e̞ y1 dzː dʲʲ dʰː ɯᵝɯᵝ lː uo1 i.4 i: yɛ5ʲ a4"
        ).split(" ")
    ...
    def get_clean_sequence(
        ...
        toks = list(
            filter(
                lambda t: [t[0]] == tokenizer.encode(t[1], do_phonemize=False),
                toks,
            )
        )
    ...
    def test_decode_with_del(self):
        ...
        tokens = tokenizer.decode(
            sample_ids[0], filter_word_delimiter_token=False
        )
    ...
    def test_offsets(self):
        ...
        outputs = tokenizer.decode(
            ...
            filter_word_delimiter_token=False,
        )
    ...
    def test_offsets_batch(self):
        ...
        def check_list_tuples_equal(outputs_batch, outputs_list):
            ...
            self.assertListEqual(
                outputs_batch["text"], outputs_batch_2["text"]
            )
            ...
            if "char_offsets" in outputs_batch:
                recursive_check(
                    outputs_batch["char_offsets"],
                    outputs_batch_2["char_offsets"],
                )
        ...
        outputs_char = [
            tokenizer.decode(ids, output_char_offsets=True)
            for ids in sample_ids
        ]
        check_list_tuples_equal(outputs_char_batch, outputs_char)

    @unittest.skip(
        "Wav2Vec2PhonemeTokenizer always lower cases letters to correctly map"
        " to phonemes"
    )
    ...
    @unittest.skip(
        "encodes to text to ids, but decodes ids to phonemes -> not possible"
    ...
    @unittest.skip(
        "The tokenizer shouldn't be used to encode input IDs (except for"
        " labels), only to decode."
    )
