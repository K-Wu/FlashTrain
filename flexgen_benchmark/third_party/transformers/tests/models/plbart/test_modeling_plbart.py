...
class PLBartModelTester:
    ...
    def prepare_config_and_inputs(self):
        ...
        inputs_dict = prepare_plbart_inputs_dict(
    ...
    def create_and_check_decoder_model_past_large_inputs(
        ...
        model = (
            PLBartModel(config=config).get_decoder().to(torch_device).eval()
        )
...
class PLBartStandaloneDecoderModelTest(
    ...
    all_generative_model_classes = (
        (PLBartForCausalLM,) if is_torch_available() else ()
    )
    test_pruning = False
    is_encoder_decoder = False

    def setUp(self):
        self.model_tester = PLBartStandaloneDecoderModelTester(
