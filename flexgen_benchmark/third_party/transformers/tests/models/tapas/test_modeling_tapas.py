...
class TapasModelIntegrationTest(unittest.TestCase):
    ...
    def test_inference_question_answering_head_weak_supervision(self):
        ...
        self.assertTrue(
            torch.allclose(logits[:, -6:], expected_slice, atol=0.4)
        )
        ...
        self.assertTrue(
            torch.allclose(logits_aggregation, expected_tensor, atol=0.001)
        )
    ...
    def test_inference_question_answering_head_strong_supervision(self):
        ...
        self.assertTrue(
            torch.allclose(logits_aggregation, expected_tensor, atol=0.003)
        )
    ...
    def test_inference_classification_head(self):
        ...
        self.assertTrue(
            torch.allclose(outputs.logits, expected_tensor, atol=0.05)
        )
...
class TapasUtilitiesTest(unittest.TestCase):
    ...
    def test_gather_vectorized(self):
        ...
        index = IndexMap(
            indices=torch.as_tensor([[0, 1], [1, 0]]),
            num_segments=2,
            batch_dims=1,
        )
