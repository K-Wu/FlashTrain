...
class TFVisionEncoderDecoderMixin:
    ...
    def check_save_and_load(
        ...
        **kwargs
        ...
        with tempfile.TemporaryDirectory() as tmpdirname:
            ...
            enc_dec_model = TFVisionEncoderDecoderModel.from_pretrained(
                tmpdirname
            )
    ...
    def test_encoder_decoder_model_output_attentions(self):
        config_inputs_dict = self.prepare_config_and_inputs()
        self.check_encoder_decoder_model_output_attentions(
            **config_inputs_dict
        )
...
@require_tf
class TFViT2GPT2EncoderDecoderModelTest(
    TFVisionEncoderDecoderMixin, unittest.TestCase
):
    def get_pretrained_model(self):
    ...
    def prepare_config_and_inputs(self):
        ...
        encoder_config_and_inputs = (
            model_tester_encoder.prepare_config_and_inputs()
        )
...
class TFVisionEncoderDecoderModelTest(unittest.TestCase):
    ...
    def get_encoderdecoder_model(self):
        return TFVisionEncoderDecoderModel.from_pretrained(
    ...
    def test_configuration_tie(self):
        ...
        model = TFVisionEncoderDecoderModel(
            **self.get_encoder_decoder_models()
        )
        self._check_configuration_tie(model)
