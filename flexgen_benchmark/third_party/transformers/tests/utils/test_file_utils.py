...
class GenericUtilTests(unittest.TestCase):
    ...
    def test_find_labels(self):
        if is_torch_available():
            ...
            self.assertEqual(
                find_labels(BertForSequenceClassification), ["labels"]
            )
            self.assertEqual(
                find_labels(BertForPreTraining),
        ...
        if is_tf_available():
            ...
            self.assertEqual(
                find_labels(TFBertForSequenceClassification), ["labels"]
            )
            self.assertEqual(
                find_labels(TFBertForPreTraining),
                ["labels", "next_sentence_label"],
            )
            self.assertEqual(
        ...
        if is_flax_available():
            ...
            self.assertEqual(
                find_labels(FlaxBertForSequenceClassification), []
            )
