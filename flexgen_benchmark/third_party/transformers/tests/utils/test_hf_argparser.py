...
class OptionalExample:
    ...
    bar: Optional[float] = field(
        default=None, metadata={"help": "help message"}
    )
...
class HfArgumentParserTest(unittest.TestCase):
    ...
    def test_with_default(self):
        ...
        expected.add_argument(
            "--baz", default="toto", type=str, help="help message"
        )
        self.argparsersEqual(parser, expected)
    ...
    def test_with_list(self):
        ...
        expected.add_argument(
            "--bar_int", nargs="+", default=[1, 2, 3], type=int
        )
        expected.add_argument(
            "--foo_str",
            nargs="+",
    ...
    def test_with_required(self):
        ...
        expected = argparse.ArgumentParser()
        expected.add_argument(
            "--required_list", nargs="+", type=int, required=True
        )
    ...
    def test_parse_json(self):
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            parsed_args = parser.parse_yaml_file(
                Path(temp_local_path + ".json")
            )[0]
