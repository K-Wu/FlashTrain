...
class CopyCheckTester(unittest.TestCase):
    ...
    def check_copy_consistency(
        ...
        mode = black.Mode(
            target_versions={black.TargetVersion.PY35}, line_length=119
        )
    ...
    def test_convert_to_localized_md(self):
        ...
        md_list = (
            ...
            " (from Google Research and the Toyota Technological Institute at"
            " Chicago) released with the paper [ALBERT: A Lite BERT for"
            " Self-supervised Learning of Language"
            " Representations](https://arxiv.org/abs/1909.11942), by Zhenzhong"
            " Lan, Mingda Chen, Sebastian Goodman, Kevin Gimpel, Piyush"
            " Sharma, Radu Soricut.\n1."
            " **[DistilBERT](https://huggingface.co/transformers/model_doc/distilbert.html)**"
            " (from HuggingFace), released together with the paper"
            " [DistilBERT, a distilled version of BERT: smaller, faster,"
            " cheaper and lighter](https://arxiv.org/abs/1910.01108) by Victor"
            " Sanh, Lysandre Debut and Thomas Wolf. The same method has been"
            " applied to compress GPT2 into"
            " [DistilGPT2](https://github.com/huggingface/transformers/tree/main/examples/distillation),"
            " RoBERTa into"
            " [DistilRoBERTa](https://github.com/huggingface/transformers/tree/main/examples/distillation),"
            " Multilingual BERT into"
            " [DistilmBERT](https://github.com/huggingface/transformers/tree/main/examples/distillation)"
            " and a German version of DistilBERT.\n1."
            " **[ELECTRA](https://huggingface.co/transformers/model_doc/electra.html)**"
            " (from Google Research/Stanford University) released with the"
            " paper [ELECTRA: Pre-training text encoders as discriminators"
            " rather than generators](https://arxiv.org/abs/2003.10555) by"
            " Kevin Clark, Minh-Thang Luong, Quoc V. Le, Christopher D."
            " Manning."
        )
        localized_md_list = (
            "1. **[ALBERT](https://huggingface.co/transformers/model_doc/albert.html)**"
            " (来自 Google Research and the Toyota Technological Institute at"
            " Chicago) 伴随论文 [ALBERT: A Lite BERT for Self-supervised"
            " Learning of Language"
            " Representations](https://arxiv.org/abs/1909.11942), 由 Zhenzhong"
            " Lan, Mingda Chen, Sebastian Goodman, Kevin Gimpel, Piyush"
            " Sharma, Radu Soricut 发布。\n"
        )
        converted_md_list_sample = (
            ...
            " Sharma, Radu Soricut 发布。\n1."
            " **[DistilBERT](https://huggingface.co/transformers/model_doc/distilbert.html)**"
            " (来自 HuggingFace) 伴随论文 [DistilBERT, a distilled version of"
            " BERT: smaller, faster, cheaper and"
            " lighter](https://arxiv.org/abs/1910.01108) 由 Victor Sanh,"
            " Lysandre Debut and Thomas Wolf 发布。 The same method has been"
            " applied to compress GPT2 into"
            " [DistilGPT2](https://github.com/huggingface/transformers/tree/main/examples/distillation),"
            " RoBERTa into"
            " [DistilRoBERTa](https://github.com/huggingface/transformers/tree/main/examples/distillation),"
            ...
            " and a German version of DistilBERT.\n1."
            " **[ELECTRA](https://huggingface.co/transformers/model_doc/electra.html)**"
            " (来自 Google Research/Stanford University) 伴随论文 [ELECTRA:"
            " Pre-training text encoders as discriminators rather than"
            " generators](https://arxiv.org/abs/2003.10555) 由 Kevin Clark,"
            " Minh-Thang Luong, Quoc V. Le, Christopher D. Manning 发布。\n"
        )

        (
            num_models_equal,
            converted_md_list,
        ) = check_copies.convert_to_localized_md(
        ...
        link_unchanged_md_list = (
            "1. **[ALBERT](https://huggingface.co/transformers/main/model_doc/albert.html)**"
            " (来自 Google Research and the Toyota Technological Institute at"
            " Chicago) 伴随论文 [ALBERT: A Lite BERT for Self-supervised"
            " Learning of Language"
            " Representations](https://arxiv.org/abs/1909.11942), 由 Zhenzhong"
