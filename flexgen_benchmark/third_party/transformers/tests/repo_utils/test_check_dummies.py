...
check_dummies.PATH_TO_TRANSFORMERS = os.path.join(
    git_repo_path, "src", "transformers"
)
...
class CheckDummiesTester(unittest.TestCase):
    def test_find_backend(self):
        ...
        self.assertEqual(
            triple_backend, "sentencepiece_and_tokenizers_and_vision"
        )
    ...
    def test_read_init(self):
        ...
        self.assertIn(
            "convert_slow_tokenizer", objects["sentencepiece_and_tokenizers"]
        )
