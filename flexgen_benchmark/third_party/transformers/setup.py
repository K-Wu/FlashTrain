...
if stale_egg_info.exists():
    print(
        (
            "Warning: {} exists.\n\nIf you recently updated transformers to"
            " 3.0 or later, this is expected,\nbut it may prevent transformers"
            " from installing in editable mode.\n\nThis directory is"
            " automatically generated by Python's packaging tools.\nI will"
            " remove it now.\n\nSee https://github.com/pypa/pip/issues/5466"
            " for details.\n"
...
extras["onnx"] = (
    deps_list("onnxconverter-common", "tf2onnx") + extras["onnxruntime"]
)
...
extras["deepspeed-testing"] = (
    extras["deepspeed"] + extras["testing"] + extras["optuna"]
)
...
setup(
    ...
    author=(
        "The Hugging Face team (past and future) with the help of all our"
        " contributors"
    ...
    keywords=(
        "NLP vision speech deep learning transformer pytorch tensorflow BERT"
        " GPT-2 Wav2Vec2 ViT"
    ),
    license="Apache",
    ...
    package_data={
        "transformers": ["py.typed", "*.cu", "*.cpp", "*.cuh", "*.h"]
    },
    zip_safe=False,
