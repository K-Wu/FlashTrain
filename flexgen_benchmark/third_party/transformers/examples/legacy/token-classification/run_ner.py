...
class DataTrainingArguments:
    ...
    data_dir: str = field(
        metadata={
            "help": (
                "The input data dir. Should contain the .txt files for a"
    ...
    labels: Optional[str] = field(
        ...
        metadata={
            "help": (
                "Path to a file containing all labels. If not specified,"
...
def main():
    ...
    try:
        ...
        raise ValueError(
            ...
            f" TokenClassificationTask subclass in {module}. Available tasks"
            f" classes are: {TokenClassificationTask.__subclasses__()}"
        )
