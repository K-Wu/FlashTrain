...
class NERTransformer(BaseTransformer):
    ...
    def __init__(self, hparams):
        ...
        try:
            ...
            raise ValueError(
                f"Task {hparams.task_type} needs to be defined as a"
                f" TokenClassificationTask subclass in {module}. Available"
                " tasks classes are:"
                f" {TokenClassificationTask.__subclasses__()}"
            )
    ...
    def add_model_specific_args(parser, root_dir):
        ...
        parser.add_argument(
            ...
            type=int,
            help=(
                "The number of GPUs allocated for this, it is by default 0"
                " meaning none"
            ),
        )
