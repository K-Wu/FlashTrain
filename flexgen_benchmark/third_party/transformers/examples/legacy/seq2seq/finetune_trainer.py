...
class DataTrainingArguments:
    ...
    task: Optional[str] = field(
        ...
        metadata={
            "help": (
                "Task name, summarization (or summarization_{dataset} for"
                " pegasus) or translation"
            )
        },
    )
    ...
    val_max_target_length: Optional[int] = field(
        ...
        metadata={
            "help": (
                ...
                " truncated, sequences shorter will be padded. This argument"
                " is also used to override the ``max_length`` param of"
                " ``model.generate``, which is used during ``evaluate`` and"
                " ``predict``."
            )
        },
    )
    test_max_target_length: Optional[int] = field(
        ...
        metadata={
            "help": (
                "The maximum total sequence length for test target text after"
                " tokenization. Sequences longer than this will be truncated,"
                " sequences shorter will be padded."
            )
        },
    ...
    ignore_pad_token_for_loss: bool = field(
        ...
        metadata={
            "help": (
                "If only pad tokens should be ignored. This assumes that"
                " `config.pad_token_id` is defined."
            )
        },
    )
