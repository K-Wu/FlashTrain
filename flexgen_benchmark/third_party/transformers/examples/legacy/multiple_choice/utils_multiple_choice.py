...
class SwagProcessor(DataProcessor):
    ...
    def get_test_examples(self, data_dir):
        ...
        raise ValueError(
            ...
            " It can not be tested in current codesetting!"
        )
        return self._create_examples(
    ...
    for ex_index, example in tqdm.tqdm(
        ...
        for ending_idx, (context, ending) in enumerate(
            ...
            if (
                ...
                logger.info(
                    "Attention! you are cropping tokens (swag task is ok). If"
                    " you are training ARC and RACE and you are poping"
                    " question + options,you need to try to use a bigger max"
                    " seq length!"
                )
