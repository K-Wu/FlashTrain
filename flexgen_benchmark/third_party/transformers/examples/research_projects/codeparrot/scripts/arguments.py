...
class TrainingArguments:
    ...
    save_dir: Optional[str] = field(
        ...
        metadata={
            "help": (
                "Save dir where model repo is cloned and models updates are"
                " saved to."
            )
        },
    )
    ...
    num_warmup_steps: Optional[int] = field(
        default=750,
        metadata={
            "help": "Number of warmup steps in the learning rate schedule."
        },
    )
    ...
    gradient_checkpointing: Optional[bool] = field(
        default=True,
        metadata={
            "help": "Use gradient checkpointing to reduce memory footprint."
        },
    )
    ...
    max_eval_steps: Optional[int] = field(
        ...
        metadata={
            "help": (
                "Maximum number of evaluation steps. If -1 the full dataset is"
                " evaluated."
            )
        },
    )
    ...
    save_checkpoint_steps: Optional[int] = field(
        ...
        metadata={
            "help": (
                "Interval to save checkpoints. Measured as number of forward"
                " passes not training steps."
            )
        },
    )
    resume_from_checkpoint: Optional[str] = field(
        ...
        metadata={
            "help": (
                "States path if the training should continue from a checkpoint"
                " folder."
            )
        },
    )
...
class HumanEvalArguments:
    ...
    num_workers: Optional[int] = field(
        default=None,
        metadata={"help": "Number of workers used for code evaluation."},
    )
    num_tasks: Optional[int] = field(
        default=None,
        metadata={
            "help": (
                "The number of human-eval tasks to run. If not included all"
                " tasks are evaluated."
            )
        },
    )
    do_sample: Optional[bool] = field(
        default=True,
        metadata={
            "help": "Sample from the language model's output distribution."
        },
    )
    ...
    max_new_tokens: Optional[int] = field(
        default=256,
        metadata={"help": "Maximum number of newly generated tokens."},
    )
    ...
    batch_size: Optional[int] = field(
        default=10,
        metadata={"help": "Number of generations to run in parallel."},
    )
    ...
    HF_ALLOW_CODE_EVAL: Optional[str] = field(
        default="0",
        metadata={
            "help": "Allow `code_eval` to execute Python code on machine"
        },
    )
    device_int: Optional[int] = field(
        ...
        metadata={
            "help": (
                "Determine which device to run the `text-generation` Pipeline"
                " on. -1 is CPU and any zero or positive number corresponds to"
                " which GPU device id to run on."
            )
        },
    )
...
class PreprocessingArguments:
    ...
    num_workers: Optional[int] = field(
        ...
        metadata={
            "help": (
                "The number of CPU cores to use for parallel preprocessing."
                " Default uses the maximum available."
            )
        },
    )
    dataset_name: Optional[str] = field(
    ...
    line_max: Optional[float] = field(
        default=1000,
        metadata={
            "help": "Maximum line length in file, otherwise file is filtered."
        },
    )
    line_mean: Optional[float] = field(
        ...
        metadata={
            "help": (
                "Maximum mean line length in file, otherwise file is filtered."
            )
        },
    )
    alpha_frac: Optional[float] = field(
        ...
        metadata={
            "help": (
                "Maximum fraction of non-alphanumeric characters, otherwise"
                " file is filtered."
            )
        },
    )
    min_token_ratio: Optional[float] = field(
        ...
        metadata={
            "help": (
                "Minimum character token ratio for the file, otherwise file is"
                " filtered."
            )
        },
    )
    filter_proba: Optional[float] = field(
        ...
        metadata={
            "help": (
                "Probability for filtering config, test and uncommon files."
            )
        },
    )
