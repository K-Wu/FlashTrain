        ...
        for step, example in enumerate(train_dataloader):
            ...
            if examples == batch_size:
                ...
                if global_step % eval_interval == 0:
                    real_perp = compute_perplexity(
                        model, test_dataset, context_len
                    )
                    test_perps.append(real_perp)
...
def main():
    parser = argparse.ArgumentParser(
        description=(
            "Fine-tune a transformer model with IGF on a language modeling"
            " task"
        )
    )
    ...
    parser.add_argument(
        ...
        default=None,
        help=(
            "A jbl file containing tokenized data which can be split as"
            " objective dataset, train_dataset and test_dataset."
        ),
    )
    ...
    parser.add_argument(
        ...
        default=None,
        help=(
            "A jbl file containing the context and information gain pairs to"
            " train secondary learner."
        ),
    )
    ...
    parser.add_argument(
        ...
        required=True,
        help=(
            "The output directory where the final fine-tuned model is stored."
        ),
    )
    ...
    parser.add_argument(
        ...
        type=int,
        help=(
            "number of articles that are long enough to be used as our"
            " objective set"
        ),
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=int,
        help=(
            "decay the selectivity of our secondary learner filter from1"
            " standard deviation above average to 1 below average after 10"
            " batches"
        ),
    )
    ...
    parser.add_argument(
        ...
        type=int,
        help=(
            "The number of examples split to be used as"
            " objective_set/test_data"
        ),
    )
    ...
    parser.add_argument(
        ...
        type=float,
        help=(
            "The threshold value used by secondary learner to filter the"
            " train_data and allow only informative data as input to the model"
        ),
    )
    ...
    parser.add_argument(
        ...
        type=str,
        help=(
            "Reset the model to the original pretrained GPT-2 weights after"
            " each iteration"
        ),
    )
