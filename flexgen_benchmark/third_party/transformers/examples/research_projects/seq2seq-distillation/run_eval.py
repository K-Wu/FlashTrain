...
def run_generate(verbose=True):
    ...
    parser.add_argument(
        ...
        const=datetime_now(),
        help=(
            "use in conjunction w/ --dump-args to print with the results"
            " whatever other info you'd like, e.g. lang=en-ru. If no value is"
            " passed, the current datetime string will be used."
        ),
    )
    ...
    if args.reference_path is None and Path(args.score_path).exists():
        warnings.warn(
            f"score_path {args.score_path} will be overwritten unless you type"
            " ctrl-c."
        )
