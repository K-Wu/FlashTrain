...
class BaseTransformer(pl.LightningModule):
    ...
    def val_dataloader(self):
        return self.get_dataloader(
            "dev", self.hparams.eval_batch_size, shuffle=False
        )

    def test_dataloader(self):
        return self.get_dataloader(
            "test", self.hparams.eval_batch_size, shuffle=False
        )
    ...
    def add_model_specific_args(parser, root_dir):
        ...
        parser.add_argument(
            ...
            type=str,
            help=(
                "Where do you want to store the pre-trained models downloaded"
                " from huggingface.co"
            ),
        )
        parser.add_argument(
            ...
            type=float,
            help=(
                "Encoder layer dropout probability (Optional). Goes into"
                " model.config"
            ),
        )
        parser.add_argument(
            ...
            type=float,
            help=(
                "Decoder layer dropout probability (Optional). Goes into"
                " model.config"
            ),
        )
        parser.add_argument(
...
class LoggingCallback(pl.Callback):
    def on_batch_end(self, trainer, pl_module):
        ...
        lrs = {
            f"lr_group_{i}": lr for i, lr in enumerate(lr_scheduler.get_lr())
        }
...
def add_generic_args(parser, root_dir) -> None:
    ...
    parser.add_argument(
        ...
        required=True,
        help=(
            "The input data dir. Should contain the training files for the"
            " CoNLL-2003 NER task."
        ),
    )
