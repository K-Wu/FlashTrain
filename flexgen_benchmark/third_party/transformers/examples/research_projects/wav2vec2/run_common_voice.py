...
class ModelArguments:
    ...
    hidden_dropout: Optional[float] = field(
        ...
        metadata={
            "help": (
                "The dropout probabilitiy for all fully connected layers in"
    ...
    feat_proj_dropout: Optional[float] = field(
        ...
        metadata={
            "help": (
                "The dropout probabilitiy for all 1D convolutional layers in"
                " feature extractor."
            )
        },
    )
    mask_time_prob: Optional[float] = field(
        ...
        metadata={
            "help": (
                "Propability of each feature vector along the time axis to be"
                ...
                " time axis. This is only relevant if ``apply_spec_augment is"
                " True``."
            )
        },
    )
