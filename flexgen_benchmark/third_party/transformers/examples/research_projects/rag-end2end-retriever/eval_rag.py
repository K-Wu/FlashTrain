...
def get_args():
    ...
    parser.add_argument(
        ...
        help=(
            ...
            " specified, the type is inferred from the model_name_or_path"
        ),
    )
    parser.add_argument(
        "--index_name",
    ...
    parser.add_argument(
        ...
        required=True,
        help=(
            "Path to pretrained checkpoints or model identifier from"
    ...
    parser.add_argument(
        ...
        type=str,
        help=(
            "Evaluation mode, e2e calculates exact match and F1 of the"
            " downstream task, retrieval calculates precision@k."
        ),
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        choices=["qa", "ans"],
        help=(
            "Format of the gold data fileqa - a single line in the following"
            " format: question [tab] answer_listans - a single line of the"
            " gold file contains the expected answer string"
        ),
    )
    parser.add_argument(
        "--predictions_path",
        ...
        help=(
            "Name of the predictions file, to be stored in the checkpoints"
            " directory"
        ),
    )
    parser.add_argument(
