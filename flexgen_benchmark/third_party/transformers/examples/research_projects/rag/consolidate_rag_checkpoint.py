...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        help=(
            "Generator tokenizer identifier, if not specified, resolves to"
            " ``generator_name_or_path``"
        ),
    )
    parser.add_argument(
        ...
        type=str,
        help=(
            "Question encoder tokenizer identifier, if not specified, resolves"
            " to ``question_encoder_name_or_path``"
        ),
    )
    parser.add_argument(
        "--config_name_or_path",
        type=str,
        help=(
            "Identifier of the model config to use, if not provided, resolves"
            " to a base config for a given ``model_type``"
        ),
    )
