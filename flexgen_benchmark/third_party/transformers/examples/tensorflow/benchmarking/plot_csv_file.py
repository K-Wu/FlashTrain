...
class PlotArguments:
    ...
    plot_along_batch: bool = field(
        ...
        metadata={
            "help": (
                "Whether to plot along batch size or sequence length. Defaults"
                " to sequence length."
            )
        },
    )
    is_time: bool = field(
        ...
        metadata={
            "help": (
                "Whether the csv file has time results or memory results."
                " Defaults to memory results."
            )
        },
    )
    ...
    is_train: bool = field(
        ...
        metadata={
            "help": (
                "Whether the csv file has training results or inference"
                " results. Defaults to inference results."
            )
        },
    )
    figure_png_file: Optional[str] = field(
        ...
        metadata={
            "help": (
                "Filename under which the plot will be saved. If unused no"
                " plot is saved."
            )
        },
    )
    short_model_names: Optional[List[str]] = list_field(
        ...
        metadata={
            "help": (
                "List of model names that are used instead of the ones in the"
                " csv file."
            )
        },
    )
        ...
        for model_name_idx, model_name in enumerate(self.result_dict.keys()):
            ...
            for inner_loop_value in inner_loop_array:
                ...
                plt.scatter(
                    ...
                    y_axis_array,
                    label=(
                        f"{label_model_name} - {inner_loop_label}:"
                        f" {inner_loop_value}"
                    ),
                )
