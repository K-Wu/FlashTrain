...
def main():
    ...
    send_example_telemetry(
        "run_clm", model_args, data_args, framework="tensorflow"
    )
    ...
    if data_args.validation_file is not None:
        ...
        logger.info(
            "Validation file not found: using"
            f" {data_args.validation_split_percentage}% of the dataset as"
            " validation as provided in data_args"
        )
    ...
    with training_args.strategy.scope():
        ...
        num_train_steps = len(tf_train_dataset) * int(
        ...
        logger.info(
            ...
            f" {training_args.per_device_train_batch_size * num_replicas}"
        )
