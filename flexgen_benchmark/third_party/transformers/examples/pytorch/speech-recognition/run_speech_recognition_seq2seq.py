...
class ModelArguments:
    ...
    feature_extractor_name: Optional[str] = field(
        ...
        metadata={
            "help": (
                "feature extractor name or path if not the same as model_name"
            )
        },
    )
...
class DataTrainingArguments:
    ...
    max_duration_in_seconds: float = field(
        ...
        metadata={
            "help": (
                "Truncate audio files that are longer than"
...
def main():
    ...
    if (
        ...
        raise ValueError(
            f"--audio_column_name '{data_args.audio_column_name}' not found in"
            f" dataset '{data_args.dataset_name}'. Make sure to set"
            " `--audio_column_name` to the correct audio column - one of"
