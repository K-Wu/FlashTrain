...
def parse_args():
    parser = argparse.ArgumentParser(
        description=(
            "Fine-tune a Transformers model on an image classification dataset"
        )
    )
    parser.add_argument(
        "--dataset_name",
        ...
        help=(
            ...
            " (could be your own, possibly private, dataset)."
        ),
    )
    parser.add_argument(
        "--train_dir",
    ...
    if (
        ...
        raise ValueError(
            "Need either a dataset name or a training/validation folder."
        )
