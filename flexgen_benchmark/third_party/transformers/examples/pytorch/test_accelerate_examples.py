...
class ExamplesTestsNoTrainer(TestCasePlus):
    ...
    def test_run_glue_no_trainer(self):
        ...
        self.assertTrue(
            os.path.exists(os.path.join(tmp_dir, "glue_no_trainer"))
        )
    ...
    def test_run_clm_no_trainer(self):
        ...
        self.assertTrue(os.path.exists(os.path.join(tmp_dir, "epoch_0")))
        self.assertTrue(
            os.path.exists(os.path.join(tmp_dir, "clm_no_trainer"))
        )
    ...
    def test_run_mlm_no_trainer(self):
        ...
        self.assertTrue(os.path.exists(os.path.join(tmp_dir, "epoch_0")))
        self.assertTrue(
            os.path.exists(os.path.join(tmp_dir, "mlm_no_trainer"))
        )
    ...
    def test_run_ner_no_trainer(self):
        ...
        self.assertTrue(os.path.exists(os.path.join(tmp_dir, "epoch_0")))
        self.assertTrue(
            os.path.exists(os.path.join(tmp_dir, "ner_no_trainer"))
        )
    ...
    def test_run_swag_no_trainer(self):
        ...
        self.assertTrue(
            os.path.exists(os.path.join(tmp_dir, "swag_no_trainer"))
        )
    ...
    def test_run_translation_no_trainer(self):
        ...
        self.assertTrue(os.path.exists(os.path.join(tmp_dir, "epoch_0")))
        self.assertTrue(
            os.path.exists(os.path.join(tmp_dir, "translation_no_trainer"))
        )
    ...
    def test_run_image_classification_no_trainer(self):
        ...
        self.assertTrue(
            os.path.exists(
                os.path.join(tmp_dir, "image_classification_no_trainer")
            )
        )
