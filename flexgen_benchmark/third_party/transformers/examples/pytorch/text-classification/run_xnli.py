...
class ModelArguments:
    ...
    language: str = field(
        ...
        metadata={
            "help": (
                "Evaluation language. Also train language if `train_language`"
                " is set to None."
            )
        },
    )
    train_language: Optional[str] = field(
        ...
        metadata={
            "help": (
                "Train language if it is different from the evaluation"
                " language."
            )
        },
    )
    ...
    do_lower_case: Optional[bool] = field(
        ...
        metadata={
            "help": (
                "arg to indicate if tokenizer should do lower case in"
