...
def parse_args():
    ...
    parser.add_argument(
        ...
        default=False,
        help=(
            "Whether to pad all samples to model maximum sentence length. If"
            " False, will pad the samples dynamically when batching to the"
            " maximum length in the batch. Moreefficient on GPU but very bad"
            " for TPU."
        ),
    )
    parser.add_argument(
