...
class DataTrainingArguments:
    ...
    context_column: Optional[str] = field(
        ...
        metadata={
            "help": (
                ...
                " contexts (for question answering)."
            )
        },
    )
    ...
    test_file: Optional[str] = field(
        ...
        metadata={
            "help": (
                "An optional input test data file to evaluate the perplexity"
                " on (a text file)."
            )
        },
    )
    ...
    max_answer_length: int = field(
        ...
        metadata={
            "help": (
                "The maximum length of an answer that can be generated. This"
                " is needed because the start and end predictions are not"
    ...
    val_max_answer_length: Optional[int] = field(
        ...
        metadata={
            "help": (
                ...
                " `max_answer_length`.This argument is also used to override"
                " the ``max_length`` param of ``model.generate``, which is"
    ...
    pad_to_max_length: bool = field(
        ...
        metadata={
            "help": (
                ...
                " will pad the samples dynamically when batching to the"
                " maximum length in the batch (which can be faster on GPU but"
                " will be slower on TPU)."
            )
        },
    )
    ...
    null_score_diff_threshold: float = field(
        ...
        metadata={
            "help": (
                "The threshold used to select the null answer: if the best"
                " answer has a score that is less than the score of the null"
                " answer minus this threshold, the null answer is selected for"
                " this example. Only useful when"
    ...
    doc_stride: int = field(
        ...
        metadata={
            "help": (
                "When splitting up a long document into chunks, how much"
    ...
    n_best_size: int = field(
        ...
        metadata={
            "help": (
                "The total number of n-best predictions to generate when"
    ...
    num_beams: Optional[int] = field(
        ...
        metadata={
            "help": (
                ...
                " passed to ``model.generate``, which is used during"
    ...
    ignore_pad_token_for_loss: bool = field(
        ...
        metadata={
            "help": (
                "Whether to ignore the tokens corresponding to padded labels"
                " in the loss computation or not."
            )
        },
    )
...
def main():
    ...
    if data_args.question_column is None:
        ...
        if question_column not in column_names:
            raise ValueError(
                f"--question_column' value '{data_args.question_column}' needs"
    ...
    if data_args.context_column is None:
        ...
        if context_column not in column_names:
            raise ValueError(
                f"--context_column' value '{data_args.context_column}' needs"
                f" to be one of: {', '.join(column_names)}"
            )
    if data_args.answer_column is None:
        ...
        if answer_column not in column_names:
            raise ValueError(
                f"--answer_column' value '{data_args.answer_column}' needs to"
                f" be one of: {', '.join(column_names)}"
            )
    ...
    if training_args.label_smoothing_factor > 0 and not hasattr(
        ...
        logger.warning(
            ...
            f" for`{model.__class__.__name__}`. This will lead to loss being"
            " calculated twice and will take up more memory"
        )
    ...
    def post_processing_function(
        ...
        references = [
            {"id": ex["id"], "answers": ex[answer_column]} for ex in examples
        ]
