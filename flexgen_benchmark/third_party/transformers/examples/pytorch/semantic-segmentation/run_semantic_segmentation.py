...
class DataTrainingArguments:
    ...
    dataset_name: Optional[str] = field(
        ...
        metadata={
            "help": (
                "Name of a dataset from the hub (could be your own, possibly"
                " private dataset hosted on the hub)."
            )
        },
    )
    ...
    reduce_labels: Optional[bool] = field(
        ...
        metadata={
            "help": (
                "Whether or not to reduce all labels by 1 and replace"
                " background by 255."
            )
        },
    )
    ...
    def __post_init__(self):
        if self.dataset_name is None and (
            ...
            raise ValueError(
                "You must specify either a dataset name from the hub or a"
                " train and/or validation directory."
            )
