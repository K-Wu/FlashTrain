...
class ModelArguments:
    ...
    mask_ratio: float = field(
        ...
        metadata={
            "help": (
                "The ratio of the number of masked tokens in the input"
                " sequence."
            )
        },
    )
    norm_pix_loss: bool = field(
        ...
        metadata={
            "help": (
                "Whether or not to train with normalized pixel values as"
                " target."
            )
        },
    )
...
class CustomTrainingArguments(TrainingArguments):
    base_learning_rate: float = field(
        ...
        metadata={
            "help": (
                "Base learning rate: absolute_lr = base_lr * total_batch_size"
                " / 256."
            )
        },
    )
