...
class DataTrainingArguments:
    ...
    image_column_name: Optional[str] = field(
        ...
        metadata={
            "help": (
                "The column name of the images in the files. If not set, will"
                " try to use 'image' or 'img'."
            )
        },
    )
...
class ModelArguments:
    ...
    model_name_or_path: str = field(
        ...
        metadata={
            "help": (
                "The model checkpoint for weights initialization. Can be a"
                " local path to a pytorch_model.bin or a checkpoint identifier"
                " on the hub. Don't set if you want to train a model from"
                " scratch."
            )
        },
    )
    ...
    cache_dir: Optional[str] = field(
        ...
        metadata={
            "help": (
                "Where do you want to store (cache) the pretrained"
                " models/datasets downloaded from the hub"
            )
        },
    )
    ...
    image_size: Optional[int] = field(
        ...
        metadata={
            "help": (
                "The size (resolution) of each image. If not specified, will"
                " use `image_size` of the configuration."
            )
        },
    )
    patch_size: Optional[int] = field(
        ...
        metadata={
            "help": (
                "The size (resolution) of each patch. If not specified, will"
                " use `patch_size` of the configuration."
            )
        },
    )
