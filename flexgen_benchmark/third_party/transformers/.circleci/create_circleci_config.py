...
TORCH_SCATTER_INSTALL = (
    ...
    " https://pytorch-geometric.com/whl/torch-1.12.0+cpu.html"
)
...
torch_job = CircleCIJob(
    ...
    install_steps=[
        ...
        (
            "pip install"
            " .[sklearn,torch,testing,sentencepiece,torch-speech,vision,timm]"
        ),
        TORCH_SCATTER_INSTALL,
        "pip install git+https://github.com/huggingface/accelerate",
    ],
    ...
    install_steps=[
        "sudo apt-get -y update && sudo apt-get install -y cmake",
        {
            ...
            "command": (
                ...
                " xvf jumanpp-2.0.0-rc3.tar.xz\nmkdir"
                " jumanpp-2.0.0-rc3/bld\ncd jumanpp-2.0.0-rc3/bld\nsudo cmake"
...
onnx_job = CircleCIJob(
    ...
    install_steps=[
        ...
        (
            "pip install"
            " .[torch,tf,testing,sentencepiece,onnxruntime,vision,rjieba]"
        ),
    ],
...
def create_circleci_config(folder=None):
    ...
    if len(jobs) > 0:
        ...
        with open(os.path.join(folder, "generated_config.yml"), "w") as f:
            f.write(
                yaml.dump(config, indent=2, width=1000000, sort_keys=False)
            )
