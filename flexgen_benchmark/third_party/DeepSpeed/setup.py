...
try:
    ...
    print(
        ...
        " Please visit https://pytorch.org/ to see how to properly install"
        " torch on your system."
    )
...
extras_require = {
    ...
    "readthedocs": fetch_requirements(
        "requirements/requirements-readthedocs.txt"
    ),
    "dev": fetch_requirements("requirements/requirements-dev.txt"),
    "autotuning": fetch_requirements(
        "requirements/requirements-autotuning.txt"
    ),
    "autotuning_ml": fetch_requirements(
        "requirements/requirements-autotuning-ml.txt"
    ),
    "sparse_attn": fetch_requirements(
...
if torch_available and not torch.cuda.is_available():
    ...
    print(
        "[WARNING] Torch did not find cuda available, if cross-compiling or"
        " running with cpu only you can ignore this message. Adding compute"
        " capability for Pascal, Volta, and Turing (compute capabilities 6.0,"
        " 6.1, 6.2)"
    )
...
if BUILD_OP_DEFAULT:
    assert torch_available, (
        "Unable to pre-compile ops without torch installed. Please install"
        " torch before attempting to pre-compile ops."
    )
