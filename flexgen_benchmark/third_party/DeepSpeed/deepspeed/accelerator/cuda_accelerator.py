...
class CUDA_Accelerator(DeepSpeedAccelerator):
    ...
    def create_op_builder(self, class_name):
        ...
        from deepspeed.ops.op_builder.builder_names import (
            AsyncIOBuilder as AsyncIOBuilderName,
        )
        from deepspeed.ops.op_builder.builder_names import (
            CPUAdagradBuilder as CPUAdagradBuilderName,
        )
        from deepspeed.ops.op_builder.builder_names import (
            CPUAdamBuilder as CPUAdamBuilderName,
        )
        from deepspeed.ops.op_builder.builder_names import (
            FusedAdamBuilder as FusedAdamBuilderName,
        )
        from deepspeed.ops.op_builder.builder_names import (
            FusedLambBuilder as FusedLambBuilderName,
        )
        from deepspeed.ops.op_builder.builder_names import (
            QuantizerBuilder as QuantizerBuilderName,
        )
        from deepspeed.ops.op_builder.builder_names import (
            SparseAttnBuilder as SparseAttnBuilderName,
        )
        from deepspeed.ops.op_builder.builder_names import (
            StochasticTransformerBuilder as StochasticTransformerBuilderName,
        )
        from deepspeed.ops.op_builder.builder_names import (
            TransformerBuilder as TransformerBuilderName,
        )
        from deepspeed.ops.op_builder.builder_names import (
            InferenceBuilder as InferenceBuilderName,
        )
        from deepspeed.ops.op_builder.builder_names import (
            UtilsBuilder as UtilsBuilderName,
        )
