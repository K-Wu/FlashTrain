def check_tb_availability():
    try:
        ...
        print(
            "If you want to use tensorboard logging, please `pip install"
            " tensorboard`"
        )
        raise
...
def check_wandb_availability():
    try:
        ...
        print(
            "If you want to use wandb logging, please `pip install wandb` and"
            " follow the instructions at https://docs.wandb.ai/quickstart"
        )
        raise
