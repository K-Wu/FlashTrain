...
class GPT2CheckpointTestCase(BaseTestCase):
    ...
    def run_test(self, test_config, r_tol):
        ...
        test_config["other_args"] = (
            f'"--save {checkpoint_folder} --save-interval'
            f' {checkpoint_interval} {cpu_optimizer_flag}"'
        )
        ...
        try:
            cmd = (
                f"echo {checkpoint_interval} >"
                f" {checkpoint_name}/latest_checkpointed_iteration.txt"
            )
            ...
            print(
                f"{self.id()} Failed to update the checkpoint iteration file"
            )
            return False
        ...
        print(
            "{0}: Second run loading checkpoint and continuing.".format(
                self.id()
            )
        )
    ...
    def check_parity(self, base_file, test_file, r_tol):
        ...
        print(
            "baseline loss: {0}, test loss: {1}".format(base_loss, test_loss)
        )
...
def checkpoint_suite():
    ...
    suite.addTest(
        GPT2CheckpointTestCase("test_mp2_gpu4_node1_with_zero2_offload")
    )

    # Shrink DP
    suite.addTest(
        GPT2CheckpointTestCase("test_mp1_gpu2_load_gpu1_node1_with_zero1")
    )
    suite.addTest(
        GPT2CheckpointTestCase("test_mp1_gpu2_load_gpu1_node1_with_zero2")
    )
    suite.addTest(
        GPT2CheckpointTestCase(
            "test_mp1_gpu2_load_gpu1_node1_with_zero2_offload"
        )
    )

    suite.addTest(
        GPT2CheckpointTestCase("test_mp2_gpu4_load_gpu2_node1_with_zero1")
    )
    suite.addTest(
        GPT2CheckpointTestCase("test_mp2_gpu4_load_gpu2_node1_with_zero2")
    )
    suite.addTest(
        GPT2CheckpointTestCase(
            "test_mp2_gpu4_load_gpu2_node1_with_zero2_offload"
        )
    )

    # Expand DP
    suite.addTest(
        GPT2CheckpointTestCase("test_mp1_gpu2_load_gpu4_node1_with_zero1")
    )
    suite.addTest(
        GPT2CheckpointTestCase("test_mp1_gpu2_load_gpu4_node1_with_zero2")
    )
    suite.addTest(
        GPT2CheckpointTestCase(
            "test_mp1_gpu2_load_gpu4_node1_with_zero2_offload"
        )
    )

    suite.addTest(
        GPT2CheckpointTestCase("test_mp2_gpu2_load_gpu4_node1_with_zero1")
    )
    suite.addTest(
        GPT2CheckpointTestCase("test_mp2_gpu2_load_gpu4_node1_with_zero2")
    )
    suite.addTest(
        GPT2CheckpointTestCase(
            "test_mp2_gpu2_load_gpu4_node1_with_zero2_offload"
        )
    )
