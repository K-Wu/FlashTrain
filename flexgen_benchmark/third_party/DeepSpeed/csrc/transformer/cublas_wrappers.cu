...
#endif
{
  ...
  cublasStatus_t status = cublasGemmEx(
      ...
      (transb == CUBLAS_OP_N) ? k : n, (const void*)beta, (void*)C, CUDA_R_16F,
      m, CUDA_R_32F, algo);
#endif
...
#endif
{
  ...
  rocblas_status status = rocblas_gemm_strided_batched_ex(
      ...
      stride_B, beta, C, rocblas_datatype_f16_r, m, stride_C, C,
      rocblas_datatype_f16_r, m, stride_C, batch, rocblas_datatype_f32_r, algo,
      0, 0);
#else
  cublasStatus_t status = cublasGemmStridedBatchedEx(
