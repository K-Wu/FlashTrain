...
class GroupStats {
 public:
  ...
  DS_D_INLINE void reduce(cg::thread_block& tb,
...
DS_D_INLINE void _chunk(int8_t* local_output, const __half* data,
...
*/
template <int numBits, Type qType>
DS_D_INLINE void _chunk(int8_t* local_output, const __half2* data,
                        Params<qType, numBits> q_params);
