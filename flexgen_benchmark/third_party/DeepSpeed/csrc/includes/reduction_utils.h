...
template <>
DS_D_INLINE __half2 element<ROpType::Add>(const __half2 lhs,
                                          const __half2 rhs) {
  return lhs + rhs;
}

template <>
DS_D_INLINE __half2 element<ROpType::Max>(const __half2 lhs,
                                          const __half2 rhs) {
#if __CUDA_ARCH__ >= 800
...
template <>
DS_D_INLINE __half2 element<ROpType::Min>(const __half2 lhs,
                                          const __half2 rhs) {
#if __CUDA_ARCH__ >= 800
